class Cromwell < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/broadinstitute/cromwell/releases/download/89/cromwell-89.jar"
  ...
  resource "womtool" do
    url "https://mirror.ghproxy.com/https://github.com/broadinstitute/cromwell/releases/download/89/womtool-89.jar"
