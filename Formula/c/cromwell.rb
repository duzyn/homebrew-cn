class Cromwell < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/broadinstitute/cromwell/releases/download/92/cromwell-92.jar"
  ...
  resource "womtool" do
    url "https://mirror.ghproxy.com/https://github.com/broadinstitute/cromwell/releases/download/92/womtool-92.jar"
