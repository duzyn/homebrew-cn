class Cromwell < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/broadinstitute/cromwell/releases/download/90/cromwell-90.jar"
  ...
  resource "womtool" do
    url "https://mirror.ghproxy.com/https://github.com/broadinstitute/cromwell/releases/download/90/womtool-90.jar"
