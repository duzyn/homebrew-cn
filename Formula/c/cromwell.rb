class Cromwell < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/broadinstitute/cromwell/releases/download/91/cromwell-91.jar"
  ...
  resource "womtool" do
    url "https://mirror.ghproxy.com/https://github.com/broadinstitute/cromwell/releases/download/91/womtool-91.jar"
