class Cdargs < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/cbxbiker61/cdargs/archive/refs/tags/2.1.tar.gz"
  ...
  patch do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/homebrew-core/1cf441a0/Patches/cdargs/1.35.patch"
