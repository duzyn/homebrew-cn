class Curaengine < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/Ultimaker/CuraEngine/archive/refs/tags/4.13.1.tar.gz"
  ...
  resource "fdmextruder_defaults" do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Ultimaker/Cura/4.13.1/resources/definitions/fdmextruder.def.json"
    sha256 "c03847252f9dea37277a3151c0eaeec32ded5e4cd91eed62b58e420ad8cb7fef"
  end

  resource "fdmprinter_defaults" do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Ultimaker/Cura/4.13.1/resources/definitions/fdmprinter.def.json"
