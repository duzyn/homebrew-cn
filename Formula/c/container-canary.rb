class ContainerCanary < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/NVIDIA/container-canary/archive/refs/tags/v0.5.0.tar.gz"
  ...
  test do
    ...
    resource "awesome_validator" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/NVIDIA/container-canary/refs/heads/main/examples/awesome.yaml"
