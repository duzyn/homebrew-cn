class ClozureCl < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/Clozure/ccl/archive/refs/tags/v1.13.tar.gz"
  ...
  resource "bootstrap" do
    on_macos do
      url "https://mirror.ghproxy.com/https://github.com/Clozure/ccl/releases/download/v1.13/darwinx86.tar.gz"
      sha256 "0eceab57e519f82bd6db011c596eb2a28e2a510abcd76e217d49a10e90f4002f"
    end

    on_linux do
      url "https://mirror.ghproxy.com/https://github.com/Clozure/ccl/releases/download/v1.13/linuxx86.tar.gz"
