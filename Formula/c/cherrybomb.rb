class Cherrybomb < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/blst-security/cherrybomb/archive/refs/tags/v1.0.1.tar.gz"
  ...
  test do
    resource "homebrew-testconfig" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/blst-security/cherrybomb/9e704e1cadd90c8a8a5be4e99e847dd144c68b0a/images/api-with-examples.yaml"
