class CalmCli < Formula
  ...
  test do
    resource "testdata" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/finos/architecture-as-code/refs/heads/main/calm/getting-started/conference-signup.pattern.json"
