class Curlpp < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/jpbarrette/curlpp/archive/refs/tags/v0.8.1.tar.gz"
  ...
  patch do
    ...
    on_linux do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/0089ecdbd3df70aa0efc06801d82700bd24be023/curlpp/curl-8.10.patch"
