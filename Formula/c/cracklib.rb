class Cracklib < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/cracklib/cracklib/releases/download/v2.10.1/cracklib-2.10.1.tar.bz2"
    ...
    patch do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/3bd3ae1a12ffc359a7250dc4d7aeda0029f792e5/cracklib/2.10.1-endian.patch"
  ...
  resource "cracklib-words" do
    url "https://mirror.ghproxy.com/https://github.com/cracklib/cracklib/releases/download/v2.10.1/cracklib-words-2.10.1.bz2"
