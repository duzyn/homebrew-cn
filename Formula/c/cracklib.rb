class Cracklib < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/cracklib/cracklib/releases/download/v2.10.3/cracklib-2.10.3.tar.bz2"
  ...
  resource "cracklib-words" do
    url "https://mirror.ghproxy.com/https://github.com/cracklib/cracklib/releases/download/v2.10.3/cracklib-words-2.10.3.bz2"
