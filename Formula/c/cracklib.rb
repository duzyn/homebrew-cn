class Cracklib < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/cracklib/cracklib/releases/download/v2.9.11/cracklib-2.9.11.tar.bz2"
  ...
  resource "cracklib-words" do
    url "https://mirror.ghproxy.com/https://github.com/cracklib/cracklib/releases/download/v2.9.11/cracklib-words-2.9.11.bz2"
