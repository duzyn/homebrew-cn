class Comtrya < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/comtrya/comtrya/archive/refs/tags/v0.9.0.tar.gz"
  ...
  test do
    ...
    resource "testmanifest" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/comtrya/comtrya/refs/heads/main/examples/onlyvariants/main.yaml"
