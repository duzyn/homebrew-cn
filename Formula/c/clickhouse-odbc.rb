class ClickhouseOdbc < Formula
  ...
  stable do
    ...
    url "https://mirror.ghproxy.com/https://github.com/ClickHouse/clickhouse-odbc/archive/refs/tags/v1.5.3.20260311.tar.gz"
    ...
    resource "nanodbc" do
      url "https://mirror.ghproxy.com/https://github.com/ClickHouse/nanodbc/archive/69a9376d033e1fcf483a08e2feb9f09399cf56b6.tar.gz"
