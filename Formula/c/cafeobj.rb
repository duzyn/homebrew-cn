class Cafeobj < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/CafeOBJ/cafeobj/archive/refs/tags/v1.6.2.tar.gz"
  ...
  resource "sbcl" do
    url "https://downloads.sourceforge.net/project/sbcl/sbcl/2.4.11/sbcl-2.4.11-source.tar.bz2?use_mirror=jaist"
