class Crystal < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/crystal-lang/crystal/archive/refs/tags/1.19.0.tar.gz"
    sha256 "9b1bc649408a61721b98fd027cbc53d52e75a3ac0ae12f2a0d0324adb37e9464"

    resource "shards" do
      url "https://mirror.ghproxy.com/https://github.com/crystal-lang/shards/archive/refs/tags/v0.20.0.tar.gz"
  ...
  resource "boot" do
    ...
    on_macos do
      url "https://mirror.ghproxy.com/https://github.com/crystal-lang/crystal/releases/download/#{boot_version.major_minor_patch}/crystal-#{boot_version}-darwin-universal.tar.gz"
      # version boot_version
    ...
    on_linux do
      on_arm do
        url "https://mirror.ghproxy.com/https://github.com/crystal-lang/crystal/releases/download/#{boot_version.major_minor_patch}/crystal-#{boot_version}-linux-aarch64.tar.gz"
        # version boot_version
        sha256 "4bc44af4d9eedff2980b62d57bd0cbc111dd68f5b5b5df22751056aca59948c6"
      end
      on_intel do
        url "https://mirror.ghproxy.com/https://github.com/crystal-lang/crystal/releases/download/#{boot_version.major_minor_patch}/crystal-#{boot_version}-linux-x86_64.tar.gz"
        # version boot_version
  ...
  resource "molinillo" do
    url "https://mirror.ghproxy.com/https://github.com/crystal-lang/crystal-molinillo/archive/refs/tags/v0.2.0.tar.gz"
