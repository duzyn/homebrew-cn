class Cyme < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/tuna-f1sh/cyme/archive/refs/tags/v2.2.10.tar.gz"
  ...
  test do
    ...
    if OS.linux?
      ...
      resource "usbkbd.umockdev" do
        url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/martinpitt/umockdev/1b58d24fb78e8297f2b0e96abb99fcbee7f37784/devices/input/usbkbd.umockdev"
