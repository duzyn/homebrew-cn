class ClangFormat < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/llvm/llvm-project/releases/download/llvmorg-19.1.5/llvm-19.1.5.src.tar.xz"
    sha256 "7d71635948e4da1814ce8e15ec45399e4094a5442e86d352c96ded0f2b3171b6"

    resource "clang" do
      url "https://mirror.ghproxy.com/https://github.com/llvm/llvm-project/releases/download/llvmorg-19.1.5/clang-19.1.5.src.tar.xz"
      sha256 "e7dfc8050407b5cc564c1c1afe19517255c9229cccd886dbd5bac9b652828d85"
    end

    resource "cmake" do
      url "https://mirror.ghproxy.com/https://github.com/llvm/llvm-project/releases/download/llvmorg-19.1.5/cmake-19.1.5.src.tar.xz"
      sha256 "a08ae477571fd5e929c27d3d0d28c6168d58dd00b6354c2de3266ae0d86ad44f"
    end

    resource "third-party" do
      url "https://mirror.ghproxy.com/https://github.com/llvm/llvm-project/releases/download/llvmorg-19.1.5/third-party-19.1.5.src.tar.xz"
