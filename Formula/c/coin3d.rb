class Coin3d < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/coin3d/coin/releases/download/v4.0.5/coin-4.0.5-src.tar.gz"
    sha256 "0abc591cb49cbb8d97eb70251340f61cc1bd75a3ac1fa7c23907af6671c1079a"

    resource "soqt" do
      url "https://mirror.ghproxy.com/https://github.com/coin3d/soqt/releases/download/v1.6.4/soqt-1.6.4-src.tar.gz"
