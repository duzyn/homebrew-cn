class Coin3d < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/coin3d/coin/releases/download/v4.0.4/coin-4.0.4-src.tar.gz"
    sha256 "80efd056a445050939a265db307d106ac7524105774d4be924a71b0cff23a719"

    resource "soqt" do
      url "https://mirror.ghproxy.com/https://github.com/coin3d/soqt/releases/download/v1.6.3/soqt-1.6.3-src.tar.gz"
