class Coin3d < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/coin3d/coin/releases/download/v4.0.3/coin-4.0.3-src.tar.gz"
    sha256 "66e3f381401f98d789154eb00b2996984da95bc401ee69cc77d2a72ed86dfda8"

    resource "soqt" do
      url "https://mirror.ghproxy.com/https://github.com/coin3d/soqt/releases/download/v1.6.2/soqt-1.6.2-src.tar.gz"
    ...
    resource "pivy" do
      url "https://mirror.ghproxy.com/https://github.com/coin3d/pivy/archive/refs/tags/0.6.9.a0.tar.gz"
