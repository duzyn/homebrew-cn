class Cgrep < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/awgn/cgrep/archive/refs/tags/v9.0.0.tar.gz"
  ...
  def install
    ...
    # Issue ref: https://mirror.ghproxy.com/https://github.com/xtendo-org/rawfilepath/issues/13
    if OS.mac?
