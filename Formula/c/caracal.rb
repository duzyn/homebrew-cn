class Caracal < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/crytic/caracal/archive/refs/tags/v0.2.3.tar.gz"
  ...
  test do
    resource "corelib" do
      url "https://mirror.ghproxy.com/https://github.com/starkware-libs/cairo/archive/refs/tags/v2.5.0.tar.gz"
