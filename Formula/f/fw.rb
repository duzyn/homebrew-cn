class Fw < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/brocode/fw/archive/refs/tags/v2.20.0.tar.gz"
  ...
  resource "fw.1" do
    url "https://mirror.ghproxy.com/https://github.com/brocode/fw/releases/download/v2.19.0/fw.1"
