class Fastp < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/OpenGene/fastp/archive/refs/tags/v0.23.4.tar.gz"
  ...
  # upstream arm support issue, https://github.com/OpenGene/fastp/issues/420
