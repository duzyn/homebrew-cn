class Foma < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/mhulden/foma/archive/dfe1ccb1055af99be0232a26520d247b5fe093bc.tar.gz"
  version "0.10.0"
  sha256 "8016c800eca020a28ac2805841cce20562b617ffafe215d53a23dc9a3e252186"
  license "Apache-2.0"

  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/mhulden/foma/refs/heads/master/foma/CHANGELOG"
    regex(/v?(\d+(?:\.\d+)+)/i)
  end
