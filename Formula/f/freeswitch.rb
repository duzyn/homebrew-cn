class Freeswitch < Formula
  ...
  resource "sounds-music-8000" do
    ...
    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/signalwire/freeswitch/refs/tags/v#{LATEST_VERSION}/build/moh_version.txt"
      regex(/^v?(\d+(?:\.\d+)+)$/i)
    end
  end
  ...
  resource "sounds-en-us-callie-8000" do
    ...
    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/signalwire/freeswitch/refs/tags/v#{LATEST_VERSION}/build/sounds_version.txt"
  ...
  resource "spandsp" do
    ...
    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/signalwire/homebrew-signalwire/refs/heads/master/Formula/spandsp.rb"
