class Fpc < Formula
  ...
  url "https://downloads.sourceforge.net/project/freepascal/Source/3.2.2/fpc-3.2.2.source.tar.gz?use_mirror=jaist"
  ...
  resource "bootstrap" do
    on_macos do
      url "https://downloads.sourceforge.net/project/freepascal/Mac%20OS%20X/3.2.2/fpc-3.2.2.intelarm64-macosx.dmg?use_mirror=jaist"
      sha256 "05d4510c8c887e3c68de20272abf62171aa5b2ef1eba6bce25e4c0bc41ba8b7d"
    end
    on_linux do
      on_arm do
        url "https://downloads.sourceforge.net/project/freepascal/Linux/3.2.2/fpc-3.2.2.aarch64-linux.tar?use_mirror=jaist"
        sha256 "b39470f9b6b5b82f50fc8680a5da37d2834f2129c65c24c5628a80894d565451"
      end
      on_intel do
        url "https://downloads.sourceforge.net/project/freepascal/Linux/3.2.2/fpc-3.2.2.x86_64-linux.tar?use_mirror=jaist"
