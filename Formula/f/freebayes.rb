class Freebayes < Formula
  ...
  stable do
    ...
    url "https://mirror.ghproxy.com/https://github.com/freebayes/freebayes/archive/refs/tags/v1.3.8.tar.gz"
    ...
    resource "contrib/smithwaterman" do
      url "https://mirror.ghproxy.com/https://github.com/ekg/smithwaterman/archive/2610e259611ae4cde8f03c72499d28f03f6d38a7.tar.gz"
      sha256 "8e1b37ab0e8cd9d3d5cbfdba80258c0ebd0862749b531e213f44cdfe2fc541d8"
    end

    resource "contrib/fastahack" do
      url "https://mirror.ghproxy.com/https://github.com/ekg/fastahack/archive/bb332654766c2177d6ec07941fe43facf8483b1d.tar.gz"
      sha256 "552a1b261ea90023de7048a27c53a425a1bc21c3fb172b3c8dc9f585f02f6c43"
    end

    resource "contrib/multichoose" do
      url "https://mirror.ghproxy.com/https://github.com/vcflib/multichoose/archive/255192edd49cfe36557f7f4f0d2d6ee1c702ffbb.tar.gz"
