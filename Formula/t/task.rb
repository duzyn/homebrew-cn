class Task < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/GothenburgBitFactory/taskwarrior/releases/download/v3.0.0/task-3.0.0.tar.gz"
  ...
  patch do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/080b833258961c922d85984871a96ca55bbf519b/task/task-3.0.0.patch"
