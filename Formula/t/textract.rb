class Textract < Formula
  ...
  resource "ebcdic" do
    url "https://mirror.ghproxy.com/https://github.com/roskakori/CodecMapper/archive/refs/tags/v1.1.1.tar.gz"
  ...
  resource "SpeechRecognition" do
    ...
    url "https://mirror.ghproxy.com/https://github.com/Uberi/speech_recognition/archive/refs/tags/3.8.1.tar.gz"
