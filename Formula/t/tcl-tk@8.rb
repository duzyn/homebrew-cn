class TclTkAT8 < Formula
  ...
  url "https://downloads.sourceforge.net/project/tcl/Tcl/8.6.16/tcl8.6.16-src.tar.gz?use_mirror=jaist"
  ...
  resource "tk" do
    url "https://downloads.sourceforge.net/project/tcl/Tcl/8.6.16/tk8.6.16-src.tar.gz?use_mirror=jaist"
