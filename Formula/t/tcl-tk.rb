class TclTk < Formula
  ...
  url "https://downloads.sourceforge.net/project/tcl/Tcl/9.0.2/tcl9.0.2-src.tar.gz?use_mirror=jaist"
  ...
  resource "tk" do
    url "https://downloads.sourceforge.net/project/tcl/Tcl/9.0.2/tk9.0.2-src.tar.gz?use_mirror=jaist"
