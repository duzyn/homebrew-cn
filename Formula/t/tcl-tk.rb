class TclTk < Formula
  ...
  url "https://downloads.sourceforge.net/project/tcl/Tcl/9.0.1/tcl9.0.1-src.tar.gz?use_mirror=jaist"
  ...
  resource "critcl" do
    url "https://mirror.ghproxy.com/https://github.com/andreas-kupries/critcl/archive/refs/tags/3.3.1.tar.gz"
  ...
  resource "tcllib" do
    url "https://downloads.sourceforge.net/project/tcllib/tcllib/2.0/tcllib-2.0.tar.xz?use_mirror=jaist"
  ...
  resource "tk" do
    url "https://downloads.sourceforge.net/project/tcl/Tcl/9.0.1/tk9.0.1-src.tar.gz?use_mirror=jaist"
  ...
  # "https://downloads.sourceforge.net/project/incrtcl/%5Bincr%20Tcl_Tk%5D-4-source/itk%204.1.0/itk4.1.0.tar.gz?use_mirror=jaist"
  ...
  resource "itk4" do
    url "https://mirror.ghproxy.com/https://github.com/tcltk/itk/archive/refs/tags/itk-4-2-3.tar.gz"
    version "4.2.3"
