class TclTk < Formula
  ...
  url "https://downloads.sourceforge.net/project/tcl/Tcl/9.0.0/tcl9.0.0-src.tar.gz?use_mirror=jaist"
  ...
  resource "tk" do
    url "https://downloads.sourceforge.net/project/tcl/Tcl/9.0.0/tk9.0.0-src.tar.gz?use_mirror=jaist"
