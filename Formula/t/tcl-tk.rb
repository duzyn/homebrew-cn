class TclTk < Formula
  ...
  url "https://downloads.sourceforge.net/project/tcl/Tcl/9.0.3/tcl9.0.3-src.tar.gz?use_mirror=jaist"
  ...
  resource "tk" do
    url "https://downloads.sourceforge.net/project/tcl/Tcl/9.0.3/tk9.0.3-src.tar.gz?use_mirror=jaist"
