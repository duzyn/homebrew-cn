class Teleport < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/gravitational/teleport/archive/refs/tags/v18.7.1.tar.gz"
  ...
  resource "wasm-bindgen" do
    ...
    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/gravitational/teleport/refs/tags/v#{LATEST_VERSION}/Cargo.lock"
