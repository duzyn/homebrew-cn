class Tracy < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/wolfpld/tracy/archive/refs/tags/v0.13.1.tar.gz"
  ...
  resource "capstone" do
    url "https://mirror.ghproxy.com/https://github.com/capstone-engine/capstone/releases/download/6.0.0-Alpha6/capstone-6.0.0-Alpha6.tar.xz"
    sha256 "8ad244c35508b28d6c0751e3610a25380f34ddd892c968212794ed6a90d8e3cb"
  end

  resource "PPQSort" do
    url "https://mirror.ghproxy.com/https://github.com/GabTux/PPQSort/archive/refs/tags/v1.0.6.tar.gz"
