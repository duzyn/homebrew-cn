class TfSummarize < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/dineshba/tf-summarize/archive/refs/tags/v0.3.19.tar.gz"
  ...
  test do
    resource "tfplan.json" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/dineshba/tf-summarize/c447ded989b8e84b52d993e0b0e30139b5fb5818/example/tfplan.json"
