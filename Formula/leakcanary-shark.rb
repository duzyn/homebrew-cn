class LeakcanaryShark < Formula
  ...
  url "https://ghproxy.com/github.com/square/leakcanary/releases/download/v2.10/shark-cli-2.10.zip"
  ...
  resource "sample_hprof" do
    url "https://ghproxy.com/github.com/square/leakcanary/raw/v2.6/shark-android/src/test/resources/leak_asynctask_m.hprof"
