...
class Glibc < Formula
  ...
  resource "bootstrap-binutils" do
    on_arm do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.1.1/bootstrap-aarch64-binutils-2.43.1.tar.gz"
      sha256 "4eb48a302fd501a57be0c842c1657080abe96c1314473244f814df2ae676d951"
    end
    on_intel do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.1.1/bootstrap-x86_64-binutils-2.43.1.tar.gz"
  ...
  resource "bootstrap-bison" do
    on_arm do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.1.1/bootstrap-aarch64-bison-3.8.2.tar.gz"
      sha256 "59f5bacacc32fda6aa16427a3a894d5a1d0bc30cfc8b5e22f8b25580473e571e"
    end
    on_intel do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.1.1/bootstrap-x86_64-bison-3.8.2.tar.gz"
  ...
  resource "bootstrap-gawk" do
    on_arm do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.1.1/bootstrap-aarch64-gawk-5.3.1.tar.gz"
      sha256 "8e966760d81396b118ad84f228e2c26dc72264aad20edbd34428f743c3a202e3"
    end
    on_intel do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.1.1/bootstrap-x86_64-gawk-5.3.1.tar.gz"
  ...
  resource "bootstrap-gcc" do
    on_arm do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.1.1/bootstrap-aarch64-gcc-9.5.0.tar.gz"
      sha256 "79d7e4a257a2fcdad62e400764810f375bfc3e7b9c46a9a981cbab7f2f1daf9f"
    end
    on_intel do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.1.1/bootstrap-x86_64-gcc-9.5.0.tar.gz"
  ...
  resource "bootstrap-make" do
    on_arm do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.1.1/bootstrap-aarch64-make-4.4.1.tar.gz"
      sha256 "a0bf6d77a11763581f1236947fa1c7a89a4d6e4b5d0afbb019f7e2e48928580a"
    end
    on_intel do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.1.1/bootstrap-x86_64-make-4.4.1.tar.gz"
  ...
  resource "bootstrap-python3" do
    on_arm do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.1.1/bootstrap-aarch64-python3-3.11.10.tar.gz"
      sha256 "b8c30cfe774238c01e22a57718fbb7049c66d1d0236ac7e10079556633d0c1fe"
    end
    on_intel do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.1.1/bootstrap-x86_64-python3-3.11.10.tar.gz"
  ...
  resource "bootstrap-sed" do
    on_arm do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.1.1/bootstrap-aarch64-sed-4.9.tar.gz"
      sha256 "90558ff86eb9c4fa8046bed69ee9fb764905ed4022c99e21d6cb502f960fc6c2"
    end
    on_intel do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.1.1/bootstrap-x86_64-sed-4.9.tar.gz"
  ...
  patch do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/cde13b7cd4b6f8a475656a377d48447fd824ac8a/glibc/2.35-cve-rollup-sep2025.patch"
