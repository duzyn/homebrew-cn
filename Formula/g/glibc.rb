...
class Glibc < Formula
  ...
  resource "bootstrap-gcc" do
    on_arm do
      url "https://mirror.ghproxy.com/https://github.com/Homebrew/glibc-bootstrap/releases/download/1.2.0/bootstrap-aarch64-gcc-10.5.0.tar.gz"
  ...
  patch do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/homebrew-core/431b170696708f36aa0bd51139406e26ade0a7eb/Patches/glibc/2.39-test-fixes.patch"
