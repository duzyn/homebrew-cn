class GitBranchless < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/arxanas/git-branchless/archive/refs/tags/v0.10.0.tar.gz"
    ...
    patch do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/2d47380dce49c6b059369ff3378ab171c48f8fc3/git-branchless/0.10.0-build.patch"
