class Gmt < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/GenericMappingTools/gmt/releases/download/6.6.0/gmt-6.6.0-src.tar.xz"
  ...
  resource "dcw" do
    url "https://mirror.ghproxy.com/https://github.com/GenericMappingTools/dcw-gmt/releases/download/2.2.0/dcw-gmt-2.2.0.tar.gz"
