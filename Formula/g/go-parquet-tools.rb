class GoParquetTools < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/hangxie/parquet-tools/archive/refs/tags/v1.25.10.tar.gz"
  ...
  test do
    resource("test-parquet") do
      url "https://mirror.ghproxy.com/https://github.com/hangxie/parquet-tools/raw/v1.25.10/testdata/good.parquet"
