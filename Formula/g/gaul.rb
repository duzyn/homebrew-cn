class Gaul < Formula
  ...
  url "https://downloads.sourceforge.net/project/gaul/gaul-devel/0.1850-0/gaul-devel-0.1850-0.tar.gz?use_mirror=jaist"
  ...
  test do
    resource "gaul-examples" do
      url "https://downloads.sourceforge.net/project/gaul/gaul-examples/0.1849/gaul-examples-0.1849-0.tar.bz2?use_mirror=jaist"
