class Go < Formula
  ...
  stable do
    url "https://mirrors.aliyun.com/golang/go1.26.0.src.tar.gz"
  ...
  resource "gobootstrap" do
    ...
    on_arm do
      on_macos do
        url "https://mirrors.aliyun.com/golang/go#{version}.darwin-arm64.tar.gz"
        sha256 checksums["darwin-arm64"]
      end
      on_linux do
        url "https://mirrors.aliyun.com/golang/go#{version}.linux-arm64.tar.gz"
        sha256 checksums["linux-arm64"]
      end
    end
    on_intel do
      on_macos do
        url "https://mirrors.aliyun.com/golang/go#{version}.darwin-amd64.tar.gz"
        sha256 checksums["darwin-amd64"]
      end
      on_linux do
        url "https://mirrors.aliyun.com/golang/go#{version}.linux-amd64.tar.gz"
