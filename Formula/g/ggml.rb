class Ggml < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/ggml-org/ggml/archive/refs/tags/v0.9.8.tar.gz"
  ...
  resource "test-backend-ops.cpp" do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/ggml-org/ggml/refs/tags/v0.9.8/tests/test-backend-ops.cpp"
