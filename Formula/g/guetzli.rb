class Guetzli < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/google/guetzli/archive/refs/tags/v1.0.1.tar.gz"
  ...
  resource "test_image" do
    url "https://mirror.ghproxy.com/https://github.com/google/guetzli/releases/download/v1.0/bees.png"
