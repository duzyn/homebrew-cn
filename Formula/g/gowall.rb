class Gowall < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/Achno/gowall/archive/refs/tags/v0.2.3.tar.gz"
  ...
  resource "go-fitz" do
    url "https://mirror.ghproxy.com/https://github.com/gen2brain/go-fitz/archive/refs/tags/v1.24.15.tar.gz"
