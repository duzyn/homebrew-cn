class Groonga < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/groonga/groonga/releases/download/v15.1.4/groonga-15.1.4.tar.gz"
  ...
  resource "groonga-normalizer-mysql" do
    url "https://mirror.ghproxy.com/https://github.com/groonga/groonga-normalizer-mysql/releases/download/v1.2.6/groonga-normalizer-mysql-1.2.6.tar.gz"
