class Groonga < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/groonga/groonga/releases/download/v15.1.7/groonga-15.1.7.tar.gz"
  ...
  resource "groonga-normalizer-mysql" do
    url "https://mirror.ghproxy.com/https://github.com/groonga/groonga-normalizer-mysql/releases/download/v1.2.9/groonga-normalizer-mysql-1.2.9.tar.gz"
