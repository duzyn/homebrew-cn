class Grails < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/grails/grails-core/releases/download/v6.2.0/grails-6.2.0.zip"
  ...
  resource "cli" do
    url "https://mirror.ghproxy.com/https://github.com/grails/grails-forge/releases/download/v6.2.0/grails-cli-6.2.0.zip"
