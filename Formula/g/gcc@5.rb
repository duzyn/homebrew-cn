class GccAT5 < Formula
  ...
  on_macos do
    if OS.mac? && MacOS::Xcode.version >= "10.2"
      patch do
        url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/91d57ebe88e17255965fa88b53541335ef16f64a/gcc%405/gcc5-xcode10.2.patch"
  ...
  if DevelopmentTools.clang_build_version >= 900
    patch do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/078797f1b9/gcc%405/xcode9.patch"
  ...
  patch do
    on_high_sierra do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/413cfac6/gcc%405/10.13_headers.patch"
