class GoogleSparsehash < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/sparsehash/sparsehash/archive/refs/tags/sparsehash-2.0.4.tar.gz"
  ...
  test do
    resource "simple_test.cc" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/sparsehash/sparsehash/b621b0c53615473a172aeb7fed0164a7d4df25ba/src/simple_test.cc"
