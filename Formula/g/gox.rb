class Gox < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/mitchellh/gox/archive/refs/tags/v1.0.1.tar.gz"
  ...
  resource "pup" do
    url "https://mirror.ghproxy.com/https://github.com/ericchiang/pup/archive/refs/tags/v0.4.0.tar.gz"
