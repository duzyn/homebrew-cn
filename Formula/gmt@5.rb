class GmtAT5 < Formula
  ...
  url "https://ghproxy.com/github.com/GenericMappingTools/gmt/releases/download/5.4.5/gmt-5.4.5-src.tar.gz"
  ...
  resource "dcw" do
    url "https://ghproxy.com/github.com/GenericMappingTools/dcw-gmt/releases/download/1.1.4/dcw-gmt-1.1.4.tar.gz"
  ...
  patch do
    url "https://ghproxy.com/raw.githubusercontent.com/Homebrew/formula-patches/cdbf0de198531528db908a5d827f3d2e5b9618cc/gmt%405/netcdf-4.7.4.patch"
