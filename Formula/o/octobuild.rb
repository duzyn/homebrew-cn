class Octobuild < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/octobuild/octobuild/archive/refs/tags/1.7.1.tar.gz"
  ...
  resource "ipc-rs" do
    on_linux do
      on_arm do
        url "https://mirror.ghproxy.com/https://github.com/octobuild/ipc-rs/archive/e8d76ee36146d4548d18ba8480bf5b5a2f116eac.tar.gz"
