class Openjph < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/aous72/OpenJPH/archive/refs/tags/0.18.2.tar.gz"
  ...
  test do
    resource "homebrew-test.ppm" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/aous72/jp2k_test_codestreams/ca2d370/openjph/references/Malamute.ppm"
