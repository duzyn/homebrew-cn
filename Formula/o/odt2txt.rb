class Odt2txt < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/dstosberg/odt2txt/archive/refs/tags/v0.5.tar.gz"
  ...
  test do
    resource "homebrew-sample" do
      url "https://mirror.ghproxy.com/https://github.com/Turbo87/odt2txt/raw/samples/samples/sample-1.odt"
