class OsmGpsMap < Formula
  ...
  stable do
    ...
    patch do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/void-linux/void-packages/f6b0cf8ca04678301773327b9a2d5efb043dae3d/srcpkgs/libosmgpsmap/patches/libsoup-3.patch"
