class OpenexrAT2 < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/AcademySoftwareFoundation/openexr/archive/refs/tags/v2.5.8.tar.gz"
  ...
  resource "exr" do
    url "https://mirror.ghproxy.com/https://github.com/AcademySoftwareFoundation/openexr-images/raw/master/TestImages/AllHalfValues.exr"
