class Otf2bdf < Formula
  ...
  resource "test-font" do
    on_linux do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/paddykontschak/finder/master/fonts/LucidaGrande.ttc"
      sha256 "e188b3f32f5b2d15dbf01e9b4480fed899605e287516d7c0de6809d8e7368934"
    end
  end

  resource "mkinstalldirs" do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/jirutka/otf2bdf/master/mkinstalldirs"
