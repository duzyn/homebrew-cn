class Osqp < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/osqp/osqp/archive/refs/tags/v0.6.3.tar.gz"
  ...
  resource "qdldl" do
    url "https://mirror.ghproxy.com/https://github.com/osqp/qdldl/archive/refs/tags/v0.1.7.tar.gz"
