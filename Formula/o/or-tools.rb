class OrTools < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/google/or-tools/archive/refs/tags/v9.14.tar.gz"
  ...
  patch do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/homebrew-core/6d739af5/Patches/or-tools/abseil-bump.diff"
