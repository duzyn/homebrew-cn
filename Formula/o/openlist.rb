class Openlist < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/OpenListTeam/OpenList/archive/refs/tags/v4.1.6.tar.gz"
  ...
  resource "frontend" do
    url "https://mirror.ghproxy.com/https://github.com/OpenListTeam/OpenList-Frontend/archive/refs/tags/v4.1.6.tar.gz"
    sha256 "6bd3f5b2b28578d6047753eba8315516e8747d4bc5262817fa2cc9ba96490bad"
  end

  resource "i18n" do
    url "https://mirror.ghproxy.com/https://github.com/OpenListTeam/OpenList-Frontend/releases/download/v4.1.6/i18n.tar.gz"
