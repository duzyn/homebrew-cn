class Openlist < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/OpenListTeam/OpenList/archive/refs/tags/v4.1.9.tar.gz"
  ...
  resource "frontend" do
    url "https://mirror.ghproxy.com/https://github.com/OpenListTeam/OpenList-Frontend/archive/refs/tags/v4.1.9.tar.gz"
  ...
  resource "i18n" do
    url "https://mirror.ghproxy.com/https://github.com/OpenListTeam/OpenList-Frontend/releases/download/v4.1.9/i18n.tar.gz"
