class Oasdiff < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/oasdiff/oasdiff/archive/refs/tags/v1.11.10.tar.gz"
  ...
  test do
    resource "homebrew-openapi-test1.yaml" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/oasdiff/oasdiff/8fdb99634d0f7f827810ee1ba7b23aa4ada8b124/data/openapi-test1.yaml"
      sha256 "f98cd3dc42c7d7a61c1056fa5a1bd3419b776758546cf932b03324c6c1878818"
    end

    resource "homebrew-openapi-test5.yaml" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/oasdiff/oasdiff/8fdb99634d0f7f827810ee1ba7b23aa4ada8b124/data/openapi-test5.yaml"
