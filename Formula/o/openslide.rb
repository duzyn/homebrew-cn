class Openslide < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/openslide/openslide/releases/download/v4.0.0/openslide-4.0.0.tar.xz"
  ...
  test do
    resource "homebrew-svs" do
      url "https://mirror.ghproxy.com/https://github.com/libvips/libvips/raw/d510807e/test/test-suite/images/CMU-1-Small-Region.svs"
