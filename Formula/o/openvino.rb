class Openvino < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/openvinotoolkit/openvino/archive/refs/tags/2026.0.0.tar.gz"
  ...
  on_linux do
    ...
    resource "onednn_gpu" do
      url "https://mirror.ghproxy.com/https://github.com/uxlfoundation/oneDNN/archive/929fe4e5629be2a5e89f1ba13b13458b965ffe57.tar.gz"
  ...
  on_arm do
    ...
    resource "arm_compute" do
      url "https://mirror.ghproxy.com/https://github.com/ARM-software/ComputeLibrary/archive/007264fa740de5723ebddef16b7bb3657692c088.tar.gz"
      sha256 "f743953fb0d91f6ef69712ec81bd5921dc1fc08af5e6bbb8645a4595ca9c6fd7"
    end
    resource "arm_kleidiai" do
      url "https://mirror.ghproxy.com/https://github.com/ARM-software/kleidiai/archive/7d82645ca2f3c3d58a5c0b1a96905e53916c8ff8.tar.gz"
  ...
  resource "pybind11" do
    url "https://mirror.ghproxy.com/https://github.com/pybind/pybind11/archive/refs/tags/v3.0.1.tar.gz"
  ...
  resource "xbyak" do
    on_intel do
      url "https://mirror.ghproxy.com/https://github.com/herumi/xbyak/archive/refs/tags/v7.28.tar.gz"
      sha256 "c8da3d85fa322303cb312d6315592547952d7bb81f58bf98bc0a26ecd88be495"
    end
  end

  resource "mlas" do
    url "https://mirror.ghproxy.com/https://github.com/openvinotoolkit/mlas/archive/d1bc25ec4660cddd87804fcf03b2411b5dfb2e94.tar.gz"
    sha256 "0a44fbfd4b13e8609d66ddac4b11a27c90c1074cde5244c91ad197901666004c"
  end

  resource "onednn_cpu" do
    url "https://mirror.ghproxy.com/https://github.com/openvinotoolkit/oneDNN/archive/c6b79c1207bd5f20b9395536dab1d71a47cfcb1d.tar.gz"
