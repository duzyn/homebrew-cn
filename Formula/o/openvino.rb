class Openvino < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/openvinotoolkit/openvino/archive/refs/tags/2024.5.0.tar.gz"
  ...
  on_linux do
    ...
    resource "onednn_gpu" do
      url "https://mirror.ghproxy.com/https://github.com/oneapi-src/oneDNN/archive/1722066ad4c0f15495f2d0fcbe9deb2bfd188c36.tar.gz"
  ...
  on_arm do
    ...
    resource "arm_compute" do
      url "https://mirror.ghproxy.com/https://github.com/ARM-software/ComputeLibrary/archive/refs/tags/v24.09.tar.gz"
  ...
  resource "onednn_cpu" do
    url "https://mirror.ghproxy.com/https://github.com/openvinotoolkit/oneDNN/archive/c60a9946aa2386890e5c9f5587974facb7624227.tar.gz"
    sha256 "37cea8af9772053fd6d178817f64d59e3aa7de9fd8f1aa21873075bb0664240f"
  end

  resource "onnx" do
    url "https://mirror.ghproxy.com/https://github.com/onnx/onnx/archive/refs/tags/v1.17.0.tar.gz"
