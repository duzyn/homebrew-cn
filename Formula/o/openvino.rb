class Openvino < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/openvinotoolkit/openvino/archive/refs/tags/2024.1.0.tar.gz"
  ...
  on_linux do
    ...
    resource "onednn_gpu" do
      url "https://mirror.ghproxy.com/https://github.com/oneapi-src/oneDNN/archive/4e6ff043c439652fcf6c400ac4e0c81bbac7c71c.tar.gz"
  ...
  on_arm do
    ...
    resource "arm_compute" do
      url "https://mirror.ghproxy.com/https://github.com/ARM-software/ComputeLibrary/archive/refs/tags/v24.02.1.tar.gz"
  ...
  resource "onednn_cpu" do
    url "https://mirror.ghproxy.com/https://github.com/openvinotoolkit/oneDNN/archive/26633ae49edd4353a29b7170d9fcef6b2d79f4b3.tar.gz"
    sha256 "3cd4a2aea30cd6ca689e63545cf986f8e83c88333b73d42bb750fcaf08940b17"
  end

  resource "onnx" do
    url "https://mirror.ghproxy.com/https://github.com/onnx/onnx/archive/refs/tags/v1.15.0.tar.gz"
