class LlvmAT12 < Formula
  ...
  url "https://ghproxy.com/github.com/llvm/llvm-project/releases/download/llvmorg-12.0.1/llvm-project-12.0.1.src.tar.xz"
  ...
  on_linux do
    ...
    patch do
      url "https://ghproxy.com/raw.githubusercontent.com/Homebrew/formula-patches/f0b8ff8b7ad4c2e1d474b214cd615a98e0caa796/llvm/llvm.patch"
