class Gnirehtet < Formula
  ...
  stable do
    ...
    patch do
      url "https://ghproxy.com/raw.githubusercontent.com/Homebrew/formula-patches/d62149f/gnirehtet/2.5-rust-1.64.0.patch"
  ...
  resource "java_bundle" do
    url "https://ghproxy.com/github.com/Genymobile/gnirehtet/releases/download/v2.5/gnirehtet-java-v2.5.zip"
