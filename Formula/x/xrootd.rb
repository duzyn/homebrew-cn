class Xrootd < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/xrootd/xrootd/releases/download/v5.6.8/xrootd-5.6.8.tar.gz"
  mirror "https://xrootd.slac.stanford.edu/download/v5.6.8/xrootd-5.6.8.tar.gz"
