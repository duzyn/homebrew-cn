class Xleak < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/bgreenwell/xleak/archive/refs/tags/v0.2.5.tar.gz"
  ...
  test do
    ...
    resource "testfile" do
      url "https://mirror.ghproxy.com/https://github.com/chenrui333/github-action-test/releases/download/2025.11.16/test.xlsx"
