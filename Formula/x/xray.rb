class Xray < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/XTLS/Xray-core/archive/refs/tags/v25.12.1.tar.gz"
  ...
  resource "geoip" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/geoip/releases/download/202511210201/geoip.dat"
    sha256 "2445b44d9ae3ab9a867c9d1e0e244646c4c378622e14b9afaf3658ecf46a40b9"
  end

  resource "geosite" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/domain-list-community/releases/download/20251201150926/dlc.dat"
    sha256 "868d244cdc8e55166c372bdcfef4ef73c45c77eb96420bf684af658fc34475b7"
  end

  resource "example_config" do
    # borrow v2ray example config
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/v2fly/v2ray-core/v5.41.0/release/config/config.json"
