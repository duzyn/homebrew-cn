class Xray < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/XTLS/Xray-core/archive/refs/tags/v25.7.26.tar.gz"
  ...
  resource "geoip" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/geoip/releases/download/202507050144/geoip.dat"
  ...
  resource "example_config" do
    ...
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/v2fly/v2ray-core/v5.37.0/release/config/config.json"
