class Xray < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/XTLS/Xray-core/archive/refs/tags/v1.8.16.tar.gz"
  ...
  resource "geoip" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/geoip/releases/download/202406200042/geoip.dat"
    sha256 "4d65e0bfc4976c65d7ce2c77ae7c06fe8bf8ab852c3d83bd2a2fa1f952e556e5"
  end

  resource "geosite" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/domain-list-community/releases/download/20240614093027/dlc.dat"
    sha256 "d3d6482b9a1d8a875ae86756058e7693bb8ce7b476f690b191498d854fe16e76"
  end

  resource "example_config" do
    # borrow v2ray example config
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/v2fly/v2ray-core/v5.15.3/release/config/config.json"
