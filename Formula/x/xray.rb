class Xray < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/XTLS/Xray-core/archive/refs/tags/v1.8.18.tar.gz"
  ...
  resource "geoip" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/geoip/releases/download/202407110044/geoip.dat"
    sha256 "83c8d38a4fff932fcbfe726c1f85c0debb1bf169afcfa18566c731a2f2c1f7b6"
  end

  resource "geosite" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/domain-list-community/releases/download/20240713050854/dlc.dat"
    sha256 "dbaba085b1de1b8b875f3db78fb367aef080f24993af01abe21f4d4ba99048be"
  end

  resource "example_config" do
    # borrow v2ray example config
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/v2fly/v2ray-core/v5.16.1/release/config/config.json"
