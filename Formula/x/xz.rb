class Xz < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/tukaani-project/xz/releases/download/v5.6.0/xz-5.6.0.tar.gz"
  mirror "https://downloads.sourceforge.net/project/lzmautils/xz-5.6.0.tar.gz?use_mirror=nchc"
