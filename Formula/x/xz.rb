class Xz < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/tukaani-project/xz/releases/download/v5.6.3/xz-5.6.3.tar.gz"
  mirror "https://downloads.sourceforge.net/project/lzmautils/xz-5.6.3.tar.gz?use_mirror=jaist"
  mirror "http://downloads.sourceforge.net/project/lzmautils/xz-5.6.3.tar.gz?use_mirror=jaist"
