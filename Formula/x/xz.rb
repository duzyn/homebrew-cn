class Xz < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/tukaani-project/xz/releases/download/v5.8.1/xz-5.8.1.tar.gz"
  mirror "https://downloads.sourceforge.net/project/lzmautils/xz-5.8.1.tar.gz?use_mirror=jaist"
  mirror "http://downloads.sourceforge.net/project/lzmautils/xz-5.8.1.tar.gz?use_mirror=jaist"
