class Mlton < Formula
  ...
  url "https://downloads.sourceforge.net/project/mlton/mlton/20241230/mlton-20241230.src.tgz?use_mirror=jaist"
  version "20241230"
  ...
  resource "bootstrap" do
    on_macos do
      ...
      on_arm do
        url "https://mirror.ghproxy.com/https://github.com/MLton/mlton/releases/download/on-20241230-release/mlton-20241230-1.arm64-darwin.macos-15_gmp-static.tgz"
      ...
      on_intel do
        url "https://mirror.ghproxy.com/https://github.com/MLton/mlton/releases/download/on-20241230-release/mlton-20241230-1.amd64-darwin.macos-13_gmp-static.tgz"
    ...
    on_linux do
      on_arm do
        url "https://mirror.ghproxy.com/https://github.com/MLton/mlton/releases/download/on-20241230-release/mlton-20241230-1.arm64-linux.ubuntu-24.04-arm_glibc2.39.tgz"
        sha256 "ae7eb9b76e7749f51284033791788b4091d3ec94bb10eddf00f076dcb588c1f7"
      end
      on_intel do
        url "https://mirror.ghproxy.com/https://github.com/MLton/mlton/releases/download/on-20241230-release/mlton-20241230-1.amd64-linux.ubuntu-24.04_glibc2.39.tgz"
