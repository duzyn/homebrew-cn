class Mkvdts2ac3 < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/JakeWharton/mkvdts2ac3/archive/refs/tags/1.6.0.tar.gz"
    ...
    patch do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/homebrew-core/1cf441a0/Patches/mkvdts2ac3/1.6.0.patch"
