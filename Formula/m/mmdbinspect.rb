class Mmdbinspect < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/maxmind/mmdbinspect/archive/refs/tags/v0.2.0.tar.gz"
  ...
  test do
    resource "homebrew-test-data" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/maxmind/MaxMind-DB/507c17e7cf266bb47bca4922aa62071cb21f6d06/test-data/GeoIP2-City-Test.mmdb"
