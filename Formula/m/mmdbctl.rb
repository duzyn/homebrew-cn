class Mmdbctl < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/ipinfo/mmdbctl/archive/refs/tags/mmdbctl-1.4.7.tar.gz"
  ...
  test do
    resource "test.mmdb" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/maxmind/MaxMind-DB/02de12f89048db626d04f8865c6fc76eac9a7a6b/test-data/GeoIP2-City-Test.mmdb"
