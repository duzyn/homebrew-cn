class MoltenVk < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/KhronosGroup/MoltenVK/archive/refs/tags/v1.4.1.tar.gz"
    ...
    resource "SPIRV-Cross" do
      ...
      livecheck do
        url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/KhronosGroup/MoltenVK/refs/tags/v#{LATEST_VERSION}/ExternalRevisions/SPIRV-Cross_repo_revision"
        regex(/^([0-9a-f]+)$/i)
      end
    end
    ...
    resource "SPIRV-Headers" do
      ...
      livecheck do
        url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/KhronosGroup/MoltenVK/refs/tags/v#{LATEST_VERSION}/ExternalRevisions/SPIRV-Headers_repo_revision"
        regex(/^([0-9a-f]+)$/i)
      end
    end
    ...
    resource "SPIRV-Tools" do
      ...
      livecheck do
        url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/KhronosGroup/MoltenVK/refs/tags/v#{LATEST_VERSION}/ExternalRevisions/SPIRV-Tools_repo_revision"
        regex(/^([0-9a-f]+)$/i)
      end
    end
    ...
    resource "Vulkan-Headers" do
      ...
      livecheck do
        url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/KhronosGroup/MoltenVK/refs/tags/v#{LATEST_VERSION}/ExternalRevisions/Vulkan-Headers_repo_revision"
        regex(/^([0-9a-f]+)$/i)
      end
    end
    ...
    resource "Vulkan-Tools" do
      ...
      livecheck do
        url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/KhronosGroup/MoltenVK/refs/tags/v#{LATEST_VERSION}/ExternalRevisions/Vulkan-Tools_repo_revision"
        regex(/^([0-9a-f]+)$/i)
      end
    end
    ...
    resource "cereal" do
      ...
      livecheck do
        url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/KhronosGroup/MoltenVK/refs/tags/v#{LATEST_VERSION}/ExternalRevisions/cereal_repo_revision"
        regex(/^([0-9a-f]+)$/i)
      end
    end
  end
