class Mp4ff < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/Eyevinn/mp4ff/archive/refs/tags/v0.51.0.tar.gz"
  ...
  test do
    resource "homebrew-init" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Eyevinn/mp4ff/v0.51.0/mp4/testdata/init.mp4"
      sha256 "09a99ab8be9a39c80dc41ac6d4c9539b16947aab95abbadec903bfcb7a322221"
    end

    resource "homebrew-segment" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Eyevinn/mp4ff/v0.51.0/mp4/testdata/1.m4s"
      sha256 "00dd5f29bc6ba64a9d8540cdbeda7a3e5be0f0ed67475ab307506d7462fc2d98"
    end

    resource "homebrew-prog" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Eyevinn/mp4ff/v0.51.0/mp4/testdata/prog_8s.mp4"
      sha256 "86651d2aa80c714440fee3499ac3dd258b75043c4ceb455d70babb7873b16feb"
    end

    resource "homebrew-subs" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Eyevinn/mp4ff/v0.51.0/cmd/mp4ff-subslister/testdata/multi_vttc.mp4"
