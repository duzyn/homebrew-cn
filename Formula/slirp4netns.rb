class Slirp4netns < Formula
  ...
  resource "test-common" do
    url "https://ghproxy.com/raw.githubusercontent.com/rootless-containers/slirp4netns/v1.2.0/tests/common.sh"
    sha256 "756149863c2397c09fabbc0a3234858ad4a5b2fd1480fb4646c8fa9d294c001a"
  end

  resource "test-api-socket" do
    url "https://ghproxy.com/raw.githubusercontent.com/rootless-containers/slirp4netns/v1.2.0/tests/test-slirp4netns-api-socket.sh"
