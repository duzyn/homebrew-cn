class Openslide < Formula
  ...
  url "https://ghproxy.com/github.com/openslide/openslide/releases/download/v3.4.1/openslide-3.4.1.tar.xz"
  ...
  resource "homebrew-svs" do
    url "https://ghproxy.com/github.com/libvips/libvips/raw/d510807e/test/test-suite/images/CMU-1-Small-Region.svs"
