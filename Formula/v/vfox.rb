class Vfox < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/version-fox/vfox/archive/refs/tags/v0.6.10.tar.gz"
  ...
  test do
    ...
    assert_match "Golang plugin, https://mirrors.aliyun.com/golang/", output
  end
end
