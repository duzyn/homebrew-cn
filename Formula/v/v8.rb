class V8 < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/v8/v8/archive/refs/tags/14.5.201.12.tar.gz"
  ...
  resource "gn" do
    ...
    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/v8/v8/refs/tags/#{LATEST_VERSION}/DEPS"
