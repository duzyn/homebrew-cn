class V2ray < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/v2fly/v2ray-core/archive/refs/tags/v5.38.0.tar.gz"
  ...
  resource "geoip" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/geoip/releases/download/202508140022/geoip.dat"
    sha256 "54761d8691a5756fdb08d2cd4d0a9c889dbaab786e1cf758592e09fb00377f53"
  end

  resource "geoip-only-cn-private" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/geoip/releases/download/202508140022/geoip-only-cn-private.dat"
    sha256 "a21358ceb15501228f49b45bde084ed76473e1816b16d69b5b764f0b3f4dcc34"
  end

  resource "geosite" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/domain-list-community/releases/download/20250826221916/dlc.dat"
