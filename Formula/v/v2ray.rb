class V2ray < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/v2fly/v2ray-core/archive/refs/tags/v5.11.0.tar.gz"
  ...
  resource "geoip" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/geoip/releases/download/202311160040/geoip.dat"
    sha256 "fe44648629b12e4818eae1a9f703e83f02261e7dcc91b06edf531f343bf16170"
  end

  resource "geoip-only-cn-private" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/geoip/releases/download/202311160040/geoip-only-cn-private.dat"
    sha256 "5cdbda3dd45b75bd563170f1e963a4b560f0c02991c16824db6d5b887e951665"
  end

  resource "geosite" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/domain-list-community/releases/download/20231118232758/dlc.dat"
