class V2ray < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/v2fly/v2ray-core/archive/refs/tags/v5.20.0.tar.gz"
  ...
  resource "geoip" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/geoip/releases/download/202410100052/geoip.dat"
    sha256 "384c0143e551dae3022b78d9e42e7d3c9c9df428710467598c258312333c88ff"
  end

  resource "geoip-only-cn-private" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/geoip/releases/download/202410100052/geoip-only-cn-private.dat"
    sha256 "56a5649fb701aeea0adb9ce29163b4ec75f9c60853e44ffc5cf6450664e41e16"
  end

  resource "geosite" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/domain-list-community/releases/download/20241007202930/dlc.dat"
