class V2ray < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/v2fly/v2ray-core/archive/refs/tags/v5.12.1.tar.gz"
  ...
  resource "geoip" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/geoip/releases/download/202311230040/geoip.dat"
    sha256 "1719c271db87f88c3480baffa61b02e28440fc3561fa031482d5fd928d13ad61"
  end

  resource "geoip-only-cn-private" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/geoip/releases/download/202311230040/geoip-only-cn-private.dat"
    sha256 "3102515134af15e30cd9c047081a63be760d435d3399c264e2d242c10e78dcaf"
  end

  resource "geosite" do
    url "https://mirror.ghproxy.com/https://github.com/v2fly/domain-list-community/releases/download/20231122065640/dlc.dat"
