class Veraxx < Formula
  ...
  resource "lua" do
    url "https://mirror.ghproxy.com/https://github.com/LuaDist/lua/archive/refs/tags/5.2.3.tar.gz"
    sha256 "c8aa2c74e8f31861cea8f030ece6b6cb18974477bd1e9e1db4c01aee8f18f5b6"
  end

  resource "luabind" do
    url "https://mirror.ghproxy.com/https://github.com/verateam/luabind/archive/refs/tags/vera-1.3.0.tar.gz"
