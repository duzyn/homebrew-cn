class Pymol < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/schrodinger/pymol-open-source/archive/refs/tags/v3.0.0.tar.gz"
  ...
  resource "mmtf-cpp" do
    url "https://mirror.ghproxy.com/https://github.com/rcsb/mmtf-cpp/archive/refs/tags/v1.1.0.tar.gz"
