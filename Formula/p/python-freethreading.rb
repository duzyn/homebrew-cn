class PythonFreethreading < Formula
  ...
  url "https://npmmirror.com/mirrors/python/3.13.2/Python-3.13.2.tgz"
  ...
  patch do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/22f07354b9778579dd3297bbce0ed3d3244dd982/python/3.13-sysconfig.diff"
