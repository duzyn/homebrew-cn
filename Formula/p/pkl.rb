class Pkl < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/apple/pkl/archive/refs/tags/0.25.2.tar.gz"
  ...
  on_macos do
    on_arm do
      patch do
        ...
        url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/apple/pkl/c1a9e9e12ff290a1e765ad03db2ec6072f292301/patches/graalVm23.patch"
