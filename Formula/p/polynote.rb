class Polynote < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/polynote/polynote/archive/refs/tags/0.7.1.tar.gz"
  ...
  resource "jep" do
    ...
    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/polynote/polynote/refs/tags/#{LATEST_VERSION}/requirements.txt"
      regex(/^jep==v?(\d+(?:\.\d+)+)$/i)
    end
  end
