class PythonAT313 < Formula
  ...
  url "https://npmmirror.com/mirrors/python/3.13.10/Python-3.13.10.tgz"
  ...
  patch do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/homebrew-core/1cf441a0/Patches/python/3.13-sysconfig.diff"
