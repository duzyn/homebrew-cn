class Pachi < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/pasky/pachi/archive/refs/tags/pachi-12.84.tar.gz"
  ...
  resource "datafiles" do
    url "https://mirror.ghproxy.com/https://github.com/pasky/pachi/releases/download/pachi-12.84/pachi-12.84-linux-static.zip", using: :nounzip
