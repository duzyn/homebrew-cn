class Perbase < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/sstadick/perbase/archive/refs/tags/v1.4.0.tar.gz"
    ...
    resource "hts-sys" do
      ...
      livecheck do
        url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/sstadick/perbase/refs/tags/v#{LATEST_VERSION}/Cargo.lock"
        regex(/name = "hts-sys"\nversion = "(\d+(?:\.\d+)+)"/i)
      end
    end
  end
