class Ptex < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/wdas/ptex/archive/refs/tags/v2.5.1.tar.gz"
  ...
  test do
    resource "homebrew-wtest" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/wdas/ptex/v2.4.2/src/tests/wtest.cpp"
