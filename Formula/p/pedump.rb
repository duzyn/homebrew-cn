class Pedump < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/zed-0xff/pedump/archive/refs/tags/v0.6.10.tar.gz"
  ...
  test do
    ...
    resource "notepad.exe" do
      url "https://mirror.ghproxy.com/https://github.com/zed-0xff/pedump/raw/master/samples/notepad.exe"
