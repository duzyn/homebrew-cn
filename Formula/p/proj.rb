class Proj < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/OSGeo/PROJ/releases/download/9.7.1/proj-9.7.1.tar.gz"
  ...
  resource "proj-data" do
    url "https://mirror.ghproxy.com/https://github.com/OSGeo/PROJ-data/releases/download/1.24.0/proj-data-1.24.zip"
