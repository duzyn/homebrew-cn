class Proj < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/OSGeo/PROJ/releases/download/9.7.0/proj-9.7.0.tar.gz"
  ...
  resource "proj-data" do
    url "https://mirror.ghproxy.com/https://github.com/OSGeo/PROJ-data/releases/download/1.23.0/proj-data-1.23.zip"
