class Proj < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/OSGeo/PROJ/releases/download/9.4.0/proj-9.4.0.tar.gz"
  ...
  resource "proj-data" do
    url "https://download.osgeo.org/proj/proj-data-1.17.tar.gz"
