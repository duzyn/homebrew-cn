class Pgloader < Formula
  ...
  stable do
    ...
    resource "qmynd" do
      url "https://mirror.ghproxy.com/https://github.com/qitab/qmynd/archive/42664f5fd15a2f308c958c1062edebec30125308.tar.gz"
      sha256 "f81c0511be76678649da1e7df2d0bf0c370ed190c11405b914378b55958ab97f"
    end

    resource "cl-ixf" do
      url "https://mirror.ghproxy.com/https://github.com/dimitri/cl-ixf/archive/ed26f87e4127e4a9e3aac4ff1e60d1f39cca5183.tar.gz"
      sha256 "22e3ad4595ff845bd610f472267a14070b3297058c597d753ac257c930094e10"
    end

    resource "cl-db3" do
      url "https://mirror.ghproxy.com/https://github.com/dimitri/cl-db3/archive/38e5ad35f025769fb7f8dcdc6e56df3e8efd8e6d.tar.gz"
      sha256 "6b7aeaa632799eb7b9ac474fbd196f4623f1093b957e6517c34c0d891cd2a21c"
    end

    resource "cl-csv" do
      url "https://mirror.ghproxy.com/https://github.com/AccelerationNet/cl-csv/archive/2d64d4183bfc91824068cd4cf3414238d3c00fe5.tar.gz"
