class Parca < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/parca-dev/parca/archive/refs/tags/v0.24.2.tar.gz"
  ...
  test do
    ...
    # server config, https://mirror.ghproxy.com/https://raw.githubusercontent.com/parca-dev/parca/cbfa19e032ee51fccd6ca9a5842129faeb27c106/parca.yaml
