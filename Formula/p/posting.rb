class Posting < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/darrenburns/posting/archive/refs/tags/2.3.0.tar.gz"
  ...
  resource "tree-sitter-languages" do
    url "https://mirror.ghproxy.com/https://github.com/Textualize/py-tree-sitter-languages/archive/refs/tags/v1.11.0b0.tar.gz"
