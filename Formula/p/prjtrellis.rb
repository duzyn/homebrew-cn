class Prjtrellis < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/YosysHQ/prjtrellis/archive/refs/tags/1.4.tar.gz"
  ...
  resource "prjtrellis-db" do
    url "https://mirror.ghproxy.com/https://github.com/YosysHQ/prjtrellis/releases/download/1.4/prjtrellis-db-1.4.zip"
