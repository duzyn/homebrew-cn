class Podman < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/containers/podman/archive/refs/tags/v5.8.0.tar.gz"
  ...
  resource "gvproxy" do
    on_macos do
      url "https://mirror.ghproxy.com/https://github.com/containers/gvisor-tap-vsock/archive/refs/tags/v0.8.8.tar.gz"
  ...
  resource "vfkit" do
    on_macos do
      url "https://mirror.ghproxy.com/https://github.com/crc-org/vfkit/archive/refs/tags/v0.6.3.tar.gz"
  ...
  resource "netavark" do
    on_linux do
      url "https://mirror.ghproxy.com/https://github.com/containers/netavark/archive/refs/tags/v1.17.2.tar.gz"
  ...
  resource "aardvark-dns" do
    on_linux do
      url "https://mirror.ghproxy.com/https://github.com/containers/aardvark-dns/archive/refs/tags/v1.17.0.tar.gz"
