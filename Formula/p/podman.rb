class Podman < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/containers/podman/archive/refs/tags/v5.4.1.tar.gz"
  ...
  resource "gvproxy" do
    on_macos do
      url "https://mirror.ghproxy.com/https://github.com/containers/gvisor-tap-vsock/archive/refs/tags/v0.8.4.tar.gz"
  ...
  resource "vfkit" do
    on_macos do
      url "https://mirror.ghproxy.com/https://github.com/crc-org/vfkit/archive/refs/tags/v0.6.0.tar.gz"
  ...
  resource "netavark" do
    on_linux do
      url "https://mirror.ghproxy.com/https://github.com/containers/netavark/archive/refs/tags/v1.13.1.tar.gz"
