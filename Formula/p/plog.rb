class Plog < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/SergiusTheBest/plog/archive/refs/tags/1.1.11.tar.gz"
  ...
  resource "freertos_kernel" do
    on_linux do
      url "https://mirror.ghproxy.com/https://github.com/FreeRTOS/FreeRTOS-Kernel/archive/refs/tags/V11.1.0.tar.gz"
