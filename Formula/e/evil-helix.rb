class EvilHelix < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/usagi-flow/evil-helix/archive/refs/tags/release-20250601b.tar.gz"
  ...
  test do
    file = "https://mirror.ghproxy.com/https://raw.githubusercontent.com/usagi-flow/evil-helix/refs/tags/release-#{version}/Cargo.toml"
