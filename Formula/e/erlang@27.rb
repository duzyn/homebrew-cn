class ErlangAT27 < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/erlang/otp/releases/download/OTP-27.3.4.3/otp_src_27.3.4.3.tar.gz"
  ...
  resource "html" do
    url "https://mirror.ghproxy.com/https://github.com/erlang/otp/releases/download/OTP-27.3.4.3/otp_doc_html_27.3.4.3.tar.gz"
