class Erlang < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/erlang/otp/releases/download/OTP-27.2.2/otp_src_27.2.2.tar.gz"
  ...
  resource "html" do
    url "https://mirror.ghproxy.com/https://github.com/erlang/otp/releases/download/OTP-27.2.2/otp_doc_html_27.2.2.tar.gz"
  ...
  resource "ex_doc" do
    url "https://mirror.ghproxy.com/https://github.com/elixir-lang/ex_doc/releases/download/v0.34.1/ex_doc_otp_26"
