class Erlang < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/erlang/otp/releases/download/OTP-27.3/otp_src_27.3.tar.gz"
  ...
  resource "html" do
    url "https://mirror.ghproxy.com/https://github.com/erlang/otp/releases/download/OTP-27.3/otp_doc_html_27.3.tar.gz"
  ...
  resource "ex_doc" do
    url "https://mirror.ghproxy.com/https://github.com/elixir-lang/ex_doc/releases/download/v0.37.0-rc.2/ex_doc_otp_26"
