class Erlang < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/erlang/otp/releases/download/OTP-28.4.1/otp_src_28.4.1.tar.gz"
  ...
  resource "html" do
    url "https://mirror.ghproxy.com/https://github.com/erlang/otp/releases/download/OTP-28.4.1/otp_doc_html_28.4.1.tar.gz"
  ...
  resource "ex_doc" do
    url "https://mirror.ghproxy.com/https://github.com/elixir-lang/ex_doc/releases/download/v0.39.3/ex_doc_otp_27"
