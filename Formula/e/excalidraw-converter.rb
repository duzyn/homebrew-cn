class ExcalidrawConverter < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/sindrel/excalidraw-converter/archive/refs/tags/v1.4.3.tar.gz"
  ...
  test do
    resource "test_input.excalidraw" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/sindrel/excalidraw-converter/refs/heads/master/test/data/test_input.excalidraw"
