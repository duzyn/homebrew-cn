class ErlangAT26 < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/erlang/otp/releases/download/OTP-26.2.5.4/otp_src_26.2.5.4.tar.gz"
  ...
  resource "html" do
    url "https://mirror.ghproxy.com/https://github.com/erlang/otp/releases/download/OTP-26.2.5.4/otp_doc_html_26.2.5.4.tar.gz"
