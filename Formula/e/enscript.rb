class Enscript < Formula
  ...
  patch :p0 do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/macports/macports-ports/a24179380383ebda2ad9209f958ef8dd4ce7354d/print/enscript/files/patch-string_h.diff"
