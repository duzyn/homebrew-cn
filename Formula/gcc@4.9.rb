class GccAT49 < Formula
  ...
  resource "gmp" do
    ...
    patch do
      url "https://ghproxy.com/raw.githubusercontent.com/Homebrew/formula-patches/010a4dc3/gmp%404/4.3.2.patch"
  ...
  if DevelopmentTools.clang_build_version >= 900
    patch do
      url "https://ghproxy.com/raw.githubusercontent.com/Homebrew/formula-patches/c2dae73416/gcc%404.9/xcode9.patch"
  ...
  patch do
    on_high_sierra do
      url "https://ghproxy.com/raw.githubusercontent.com/Homebrew/formula-patches/b7c7883d/gcc%404.9/high_sierra_2.patch"
