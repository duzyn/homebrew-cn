class RocqElpi < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/LPCIC/coq-elpi/releases/download/v3.1.0/rocq-elpi-3.1.0.tar.gz"
  ...
  resource "elpi" do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/LPCIC/elpi/refs/tags/v3.1.0/elpi.opam"
    sha256 "7b05c5835618d5f07f32ad9a7cde2fd19f4849aca9a1d8411a4ac9d15e3b21a4"
  end

  resource "ppx_optcomp" do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/janestreet/ppx_optcomp/refs/tags/v0.17.0/ppx_optcomp.opam"
