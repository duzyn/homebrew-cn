class RocqElpi < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/LPCIC/coq-elpi/releases/download/v3.3.1/rocq-elpi-3.3.1.tar.gz"
  ...
  resource "elpi" do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/LPCIC/elpi/refs/tags/v3.6.1/elpi.opam"
