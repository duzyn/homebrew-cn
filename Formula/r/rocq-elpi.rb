class RocqElpi < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/LPCIC/coq-elpi/releases/download/v3.2.0/rocq-elpi-3.2.0.tar.gz"
  ...
  resource "elpi" do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/LPCIC/elpi/refs/tags/v3.3.1/elpi.opam"
    sha256 "aca7918b921d7cd029e3d484d27ebcf2ba4eb5fea691deada7da2d8f7632e381"
  end

  resource "ppx_optcomp" do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/janestreet/ppx_optcomp/refs/tags/v0.17.1/ppx_optcomp.opam"
