class RocqElpi < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/LPCIC/coq-elpi/releases/download/v3.0.0/rocq-elpi-3.0.0.tar.gz"
  ...
  resource "elpi" do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/LPCIC/elpi/refs/tags/v3.0.1/elpi.opam"
