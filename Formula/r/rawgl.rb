class Rawgl < Formula
  ...
  homepage "https://ghproxy.com/https://github.com/cyxx/rawgl"
  url "https://ghproxy.com/https://ghproxy.com/https://github.com/cyxx/rawgl/archive/refs/tags/rawgl-0.2.1.tar.gz"
  sha256 "da00d4abbc266e94c3755c2fd214953c48698826011b1d4afbebb99396240073"
  head "https://ghproxy.com/https://github.com/cyxx/rawgl.git", branch: "master"
  ...
  patch do
    url "https://ghproxy.com/https://github.com/cyxx/rawgl/commit/483492fb.patch?full_index=1"
