class Rav1e < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/xiph/rav1e/archive/refs/tags/v0.7.0.tar.gz"
    sha256 "dd6c4b771d985f547787383f5d77bc124ac406d574a308a897da9642410c1855"

    # keep the version in sync
    resource "Cargo.lock" do
      url "https://mirror.ghproxy.com/https://github.com/xiph/rav1e/releases/download/v0.7.0/Cargo.lock"
