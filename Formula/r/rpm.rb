class Rpm < Formula
  ...
  resource "rpm-sequoia" do
    url "https://mirror.ghproxy.com/https://github.com/rpm-software-management/rpm-sequoia/archive/refs/tags/v1.8.0.tar.gz"
  ...
  patch do
    on_macos do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/NixOS/nixpkgs/3d52077f5a6331c12eeb7b6a0723b49bea10d6fe/pkgs/tools/package-management/rpm/sighandler_t-macos.patch"
