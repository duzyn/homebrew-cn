class RubyAT27 < Formula
  ...
  resource "openssl" do
    url "https://mirror.ghproxy.com/https://github.com/ruby/openssl/archive/refs/tags/v3.1.0.tar.gz"
  ...
  resource "digest" do
    url "https://mirror.ghproxy.com/https://github.com/ruby/digest/archive/refs/tags/v3.1.1.tar.gz"
