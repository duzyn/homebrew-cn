class ClangFormatAT11 < Formula
  ...
  url "https://ghproxy.com/github.com/llvm/llvm-project/releases/download/llvmorg-11.1.0/llvm-11.1.0.src.tar.xz"
  ...
  resource "clang" do
    url "https://ghproxy.com/github.com/llvm/llvm-project/releases/download/llvmorg-11.1.0/clang-11.1.0.src.tar.xz"
