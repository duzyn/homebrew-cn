class Libobjc2 < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/gnustep/libobjc2/archive/refs/tags/v2.1.tar.gz"
  ...
  resource "robin-map" do
    url "https://mirror.ghproxy.com/https://github.com/Tessil/robin-map/archive/refs/tags/v1.0.1.tar.gz"
