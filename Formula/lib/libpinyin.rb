class Libpinyin < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/libpinyin/libpinyin/archive/refs/tags/2.10.3.tar.gz"
  ...
  resource "model" do
    url "https://downloads.sourceforge.net/libpinyin/models/model20.text.tar.gz?use_mirror=jaist"
