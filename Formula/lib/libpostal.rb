class Libpostal < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/openvenues/libpostal/archive/refs/tags/v1.1.4.tar.gz"
  ...
  resource "libpostal_data" do
    url "https://mirror.ghproxy.com/https://github.com/openvenues/libpostal/releases/download/v1.0.0/libpostal_data.tar.gz"
    sha256 "d2ec50587bf3a7e46e18e5dcde32419134266f90774e3956f2c2f90d818ff9a1"

    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/openvenues/libpostal/refs/tags/v#{LATEST_VERSION}/versions/base_data"
      regex(/^v?(\d+(?:\.\d+)+)$/i)
    end
  end
  resource "parser" do
    url "https://mirror.ghproxy.com/https://github.com/openvenues/libpostal/releases/download/v1.0.0/parser.tar.gz"
    sha256 "7194e9b0095f71aecb861269f675e50703e73e352a0b9d41c60f8d8ef5a03624"

    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/openvenues/libpostal/refs/tags/v#{LATEST_VERSION}/versions/parser"
      regex(/^v?(\d+(?:\.\d+)+)$/i)
    end
  end
  resource "language_classifier" do
    url "https://mirror.ghproxy.com/https://github.com/openvenues/libpostal/releases/download/v1.0.0/language_classifier.tar.gz"
    sha256 "16a6ecb6d37e7e25d8fe514255666852ab9dbd4d9cc762f64cf1e15b4369a277"

    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/openvenues/libpostal/refs/tags/v#{LATEST_VERSION}/versions/language_classifier"
      regex(/^v?(\d+(?:\.\d+)+)$/i)
    end
  end
