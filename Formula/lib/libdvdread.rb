class Libdvdread < Formula
  ...
  stable do
    url "https://mirrors.aliyun.com/videolan/pub/videolan/libdvdread/6.1.3/libdvdread-6.1.3.tar.bz2"
  ...
  livecheck do
    url "https://mirrors.aliyun.com/videolan/pub/videolan/libdvdread/"
