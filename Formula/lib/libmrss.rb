class Libmrss < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/bakulf/libmrss/archive/refs/tags/0.19.4.tar.gz"
  ...
  test do
    (testpath/"test.c").write <<~C
      ...
      int main() {
        ...
        mrss_error_t error;
        mrss_item_t *item;
        const char *url = "https://mirror.ghproxy.com/https://raw.githubusercontent.com/git/git.github.io/master/feed.xml";
