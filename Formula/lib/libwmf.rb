class Libwmf < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/caolanm/libwmf/releases/download/v0.2.14/libwmf-0.2.14.tar.gz"
  ...
  test do
    resource "formula1.wmf" do
      url "https://mirror.ghproxy.com/https://github.com/caolanm/libwmf/raw/3ea3a65ad1b4528ed1c5795071a0142a0e61ec7b/examples/formula1.wmf"
