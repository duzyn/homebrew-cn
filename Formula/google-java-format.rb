class GoogleJavaFormat < Formula
  ...
  url "https://ghproxy.com/github.com/google/google-java-format/releases/download/v1.15.0/google-java-format-1.15.0-all-deps.jar"
  ...
  resource "google-java-format-diff" do
    url "https://ghproxy.com/raw.githubusercontent.com/google/google-java-format/v1.15.0/scripts/google-java-format-diff.py"
