class Qtlottie < Formula
  ...
  test do
    resource "rect_rotate.json" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/qt/qtlottie/888fb0ca5d5e18fe5d8b88ed721544bf204ac158/tests/manual/testApp/rect_rotate.json"
