class Cdparanoia < Formula
  ...
  patch do
    on_macos do
      url "https://ghproxy.com/raw.githubusercontent.com/Homebrew/formula-patches/2a22152/cdparanoia/osx_interface.patch"
  ...
  patch do
    on_linux do
      url "https://ghproxy.com/raw.githubusercontent.com/Homebrew/formula-patches/bfad134/cdparanoia/linux_fpic.patch"
