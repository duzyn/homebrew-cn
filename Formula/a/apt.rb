class Apt < Formula
  ...
  url "https://deb.debian.org/debian/pool/main/a/apt/apt_2.9.0.tar.xz"
  ...
  resource "triehash" do
    url "https://mirror.ghproxy.com/https://github.com/julian-klode/triehash/archive/refs/tags/v0.3.tar.gz"
  ...
  patch do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/07275a9af84b536ac737c364d66fc2eb4daf729a/apt/po4a-0.70.patch"
