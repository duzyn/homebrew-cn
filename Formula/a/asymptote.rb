class Asymptote < Formula
  ...
  url "https://downloads.sourceforge.net/project/asymptote/2.90/asymptote-2.90.src.tgz?use_mirror=jaist"
  ...
  resource "manual" do
    url "https://downloads.sourceforge.net/project/asymptote/2.90/asymptote.pdf?use_mirror=jaist"
