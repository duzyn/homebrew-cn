class Asymptote < Formula
  ...
  url "https://downloads.sourceforge.net/project/asymptote/3.08/asymptote-3.08.src.tgz?use_mirror=jaist"
  ...
  resource "manual" do
    url "https://downloads.sourceforge.net/project/asymptote/3.08/asymptote.pdf?use_mirror=jaist"
