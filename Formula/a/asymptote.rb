class Asymptote < Formula
  ...
  url "https://downloads.sourceforge.net/project/asymptote/3.05/asymptote-3.05.src.tgz?use_mirror=jaist"
  ...
  resource "manual" do
    url "https://downloads.sourceforge.net/project/asymptote/3.05/asymptote.pdf?use_mirror=jaist"
