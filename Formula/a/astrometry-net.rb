class AstrometryNet < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/dstndstn/astrometry.net/releases/download/0.97/astrometry.net-0.97.tar.gz"
  ...
  resource "fitsio" do
    url "https://mirror.ghproxy.com/https://github.com/esheldon/fitsio/archive/refs/tags/1.2.7.tar.gz"
