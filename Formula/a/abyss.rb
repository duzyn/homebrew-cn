class Abyss < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/bcgsc/abyss/releases/download/2.3.7/abyss-2.3.7.tar.gz"
  ...
  resource "btllib" do
    url "https://mirror.ghproxy.com/https://github.com/bcgsc/btllib/releases/download/v1.6.0/btllib-1.6.0.tar.gz"
