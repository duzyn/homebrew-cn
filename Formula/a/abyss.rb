class Abyss < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/bcgsc/abyss/releases/download/2.3.10/abyss-2.3.10.tar.gz"
  ...
  resource "btllib" do
    url "https://mirror.ghproxy.com/https://github.com/bcgsc/btllib/releases/download/v1.7.3/btllib-1.7.3.tar.gz"
    ...
    patch :p0 do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/freebsd/freebsd-ports/af74f60a871e4a5aa7aea787fc235a2cb760e764/devel/sdsl-lite/files/patch-include_sdsl_louds__tree.hpp"
