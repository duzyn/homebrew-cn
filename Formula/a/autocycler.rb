class Autocycler < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/rrwick/Autocycler/archive/refs/tags/v0.5.0.tar.gz"
  ...
  test do
    resource "autocycler-demo-dataset" do
      url "https://mirror.ghproxy.com/https://github.com/rrwick/Autocycler/releases/download/v0.1.0/autocycler-demo-dataset.tar"
