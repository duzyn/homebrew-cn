class Anttweakbar < Formula
  ...
  url "https://downloads.sourceforge.net/project/anttweakbar/AntTweakBar_116.zip?use_mirror=jaist"
  version "1.16"
  ...
  patch do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/62e79481/anttweakbar/anttweakbar.diff"
