class Komac < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/russellbanks/Komac/archive/refs/tags/v2.14.0.tar.gz"
  ...
  test do
    resource "testdata" do
      url "https://mirror.ghproxy.com/https://github.com/russellbanks/Komac/releases/download/v2.13.0/komac-setup-2.13.0-x86_64-pc-windows-msvc.exe"
