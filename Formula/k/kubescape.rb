class Kubescape < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/kubescape/kubescape/archive/refs/tags/v3.0.13.tar.gz"
  ...
  test do
    manifest = "https://mirror.ghproxy.com/https://raw.githubusercontent.com/GoogleCloudPlatform/microservices-demo/main/release/kubernetes-manifests.yaml"
