class Httrack < Formula
  ...
  test do
    download = "https://ghproxy.com/raw.githubusercontent.com/Homebrew/homebrew/65c59dedea31/.yardopts"
    system bin/"httrack", download, "-O", testpath
    assert_predicate testpath/"ghproxy.com/raw.githubusercontent.com", :exist?
  end
end
