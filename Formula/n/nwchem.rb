class Nwchem < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/nwchemgit/nwchem/releases/download/v7.3.1-release/nwchem-7.3.1-release.revision-23c3b41b-src.2025-11-06.tar.xz"
  version "7.3.1"
