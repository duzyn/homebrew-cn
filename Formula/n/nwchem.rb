class Nwchem < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/nwchemgit/nwchem/releases/download/v7.2.2-release/nwchem-7.2.2-release.revision-74936fb9-src.2023-11-03.tar.xz"
  version "7.2.2"
