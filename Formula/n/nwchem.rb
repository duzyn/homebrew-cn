class Nwchem < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/nwchemgit/nwchem/releases/download/v7.3.0-release/nwchem-7.3.0-release.revision-e60d3d90-src.2025-10-24.tar.xz"
  version "7.3.0"
