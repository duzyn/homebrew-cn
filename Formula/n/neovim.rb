class Neovim < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/neovim/neovim/archive/refs/tags/v0.11.2.tar.gz"
    ...
    resource "tree-sitter-c" do
      url "https://mirror.ghproxy.com/https://github.com/tree-sitter/tree-sitter-c/archive/refs/tags/v0.23.4.tar.gz"
      sha256 "b66c5043e26d84e5f17a059af71b157bcf202221069ed220aa1696d7d1d28a7a"
    end

    resource "tree-sitter-lua" do
      url "https://mirror.ghproxy.com/https://github.com/tree-sitter-grammars/tree-sitter-lua/archive/refs/tags/v0.3.0.tar.gz"
      sha256 "a34cc70abfd8d2d4b0fabf01403ea05f848e1a4bc37d8a4bfea7164657b35d31"
    end

    resource "tree-sitter-vim" do
      url "https://mirror.ghproxy.com/https://github.com/tree-sitter-grammars/tree-sitter-vim/archive/refs/tags/v0.5.0.tar.gz"
      sha256 "90019d12d2da0751c027124f27f5335babf069a050457adaed53693b5e9cf10a"
    end

    resource "tree-sitter-vimdoc" do
      url "https://mirror.ghproxy.com/https://github.com/neovim/tree-sitter-vimdoc/archive/refs/tags/v3.0.1.tar.gz"
    ...
    resource "tree-sitter-markdown" do
      url "https://mirror.ghproxy.com/https://github.com/tree-sitter-grammars/tree-sitter-markdown/archive/refs/tags/v0.4.1.tar.gz"
