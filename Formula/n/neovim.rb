class Neovim < Formula
  ...
  stable do
    ...
    url "https://mirror.ghproxy.com/https://github.com/neovim/neovim/archive/refs/tags/v0.11.6.tar.gz"
    ...
    resource "tree-sitter-c" do
      url "https://mirror.ghproxy.com/https://github.com/tree-sitter/tree-sitter-c/archive/refs/tags/v0.24.1.tar.gz"
      sha256 "25dd4bb3dec770769a407e0fc803f424ce02c494a56ce95fedc525316dcf9b48"
    end

    resource "tree-sitter-lua" do
      url "https://mirror.ghproxy.com/https://github.com/tree-sitter-grammars/tree-sitter-lua/archive/refs/tags/v0.4.1.tar.gz"
      sha256 "cef44b8773bde69d427b5e50ca95e417c86c0be91caa37a6782c90d6f529da70"
    end

    resource "tree-sitter-vim" do
      url "https://mirror.ghproxy.com/https://github.com/tree-sitter-grammars/tree-sitter-vim/archive/refs/tags/v0.8.0.tar.gz"
      sha256 "aa0a45027408bc33da0f2244272dbdc0b4e71bd18f71e5b885f6f7cbae407338"
    end

    resource "tree-sitter-vimdoc" do
      url "https://mirror.ghproxy.com/https://github.com/neovim/tree-sitter-vimdoc/archive/refs/tags/v4.1.0.tar.gz"
      sha256 "020e8f117f648c8697fca967995c342e92dbd81dab137a115cc7555207fbc84f"
    end

    resource "tree-sitter-query" do
      url "https://mirror.ghproxy.com/https://github.com/tree-sitter-grammars/tree-sitter-query/archive/refs/tags/v0.8.0.tar.gz"
      sha256 "c2b23b9a54cffcc999ded4a5d3949daf338bebb7945dece229f832332e6e6a7d"
    end

    resource "tree-sitter-markdown" do
      url "https://mirror.ghproxy.com/https://github.com/tree-sitter-grammars/tree-sitter-markdown/archive/refs/tags/v0.5.2.tar.gz"
