class Ncmdump < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/taurusxin/ncmdump/archive/refs/tags/1.2.1.tar.gz"
  ...
  test do
    resource "homebrew-test" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/taurusxin/ncmdump/516b31ab68f806ef388084add11d9e4b2253f1c7/test/test.ncm"
      sha256 "a1586bbbbad95019eee566411de58a57c3a3bd7c86d97f2c3c82427efce8964b"
    end

    resource "homebrew-expect" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/taurusxin/ncmdump/2e40815b5a83236f3feb44720954dd3a02eb00f1/test/expect.bin"
