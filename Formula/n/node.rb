class Node < Formula
  ...
  url "https://npmmirror.com/mirrors/node/v25.5.0/node-v25.5.0.tar.xz"
  ...
  resource "npm" do
    ...
    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/nodejs/node/refs/tags/v#{LATEST_VERSION}/deps/npm/package.json"
