class ClozureCl < Formula
  ...
  resource "bootstrap" do
    on_macos do
      url "https://ghproxy.com/github.com/Clozure/ccl/releases/download/v1.12.1/darwinx86.tar.gz"
      sha256 "92c5776ba1ba8548361669b50ae1655d7f127ff01d6e2107d8dccb97f2a585cd"
    end

    on_linux do
      url "https://ghproxy.com/github.com/Clozure/ccl/releases/download/v1.12.1/linuxx86.tar.gz"
