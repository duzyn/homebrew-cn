class LeakcanaryShark < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/square/leakcanary/releases/download/v2.12/shark-cli-2.12.zip"
  ...
  resource "sample_hprof" do
    url "https://mirror.ghproxy.com/https://github.com/square/leakcanary/raw/v2.6/shark-android/src/test/resources/leak_asynctask_m.hprof"
