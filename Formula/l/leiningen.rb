class Leiningen < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/technomancy/leiningen/archive/refs/tags/2.11.1.tar.gz"
  ...
  resource "jar" do
    url "https://mirror.ghproxy.com/https://github.com/technomancy/leiningen/releases/download/2.11.1/leiningen-2.11.1-standalone.jar"
