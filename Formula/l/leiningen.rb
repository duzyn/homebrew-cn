class Leiningen < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/technomancy/leiningen/archive/refs/tags/2.12.0.tar.gz"
  ...
  resource "jar" do
    url "https://mirror.ghproxy.com/https://github.com/technomancy/leiningen/releases/download/2.12.0/leiningen-2.12.0-standalone.jar"
