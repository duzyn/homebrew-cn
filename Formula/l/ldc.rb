class Ldc < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/ldc-developers/ldc/releases/download/v1.36.0/ldc-1.36.0-src.tar.gz"
  ...
  resource "ldc-bootstrap" do
    on_macos do
      on_arm do
        url "https://mirror.ghproxy.com/https://github.com/ldc-developers/ldc/releases/download/v1.36.0/ldc2-1.36.0-osx-arm64.tar.xz"
        sha256 "ba8440e2b235b3584bc129de136563996db91cd0a35e10bcccf316bee3f23a98"
      end
      on_intel do
        url "https://mirror.ghproxy.com/https://github.com/ldc-developers/ldc/releases/download/v1.36.0/ldc2-1.36.0-osx-x86_64.tar.xz"
        sha256 "7740fefcb32c19c23bf5ce4dea6e5412329f27ffa511c4101dd96b1f44999429"
      end
    end
    on_linux do
      on_arm do
        url "https://mirror.ghproxy.com/https://github.com/ldc-developers/ldc/releases/download/v1.36.0/ldc2-1.36.0-linux-aarch64.tar.xz"
        sha256 "11cb6c554b351a00525089659c97a0e6fc568b1814e69407600315997d1852eb"
      end
      on_intel do
        url "https://mirror.ghproxy.com/https://github.com/ldc-developers/ldc/releases/download/v1.36.0/ldc2-1.36.0-linux-x86_64.tar.xz"
