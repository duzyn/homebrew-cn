class Luvit < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/luvit/luvit/archive/refs/tags/2.18.1.tar.gz"
  ...
  resource "lit" do
    ...
    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/luvit/luvit/#{LATEST_VERSION}/Makefile"
      regex(/LIT_VERSION=["']?(\d+(?:\.\d+)+)["']?$/i)
    end
  end

  # To update this resource, check LUVI_VERSION in
  # https://mirror.ghproxy.com/https://github.com/luvit/lit/raw/$(LIT_VERSION)/get-lit.sh
  resource "luvi" do
    url "https://mirror.ghproxy.com/https://github.com/luvit/luvi/releases/download/v2.12.0/luvi-src-v2.12.0.tar.gz"
    ...
    livecheck do
      ...
      strategy :page_match do |page, regex|
        ...
        get_lit_page = Homebrew::Livecheck::Strategy.page_content(
          "https://mirror.ghproxy.com/https://raw.githubusercontent.com/luvit/lit/#{lit_version}/get-lit.sh",
        )
  ...
  resource "lua-openssl" do
    url "https://mirror.ghproxy.com/https://github.com/zhaozg/lua-openssl/releases/download/0.8.3-1/openssl-0.8.3-1.tar.gz"
