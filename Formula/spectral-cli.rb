...
class SpectralCli < Formula
  ...
  resource "homebrew-petstore.yaml" do
    url "https://ghproxy.com/raw.githubusercontent.com/OAI/OpenAPI-Specification/b12acf0c/examples/v3.0/petstore.yaml"
    sha256 "7dc119919441597e2b24335d8c8f6d01f1f0b895637f79b35e3863a3c2df9ddf"
  end

  resource "homebrew-streetlights-mqtt.yml" do
    url "https://ghproxy.com/raw.githubusercontent.com/asyncapi/spec/1e3ec47f/examples/streetlights-mqtt.yml"
