class Cracklib < Formula
  ...
  url "https://ghproxy.com/github.com/cracklib/cracklib/releases/download/v2.9.8/cracklib-2.9.8.tar.bz2"
  ...
  resource "cracklib-words" do
    url "https://ghproxy.com/github.com/cracklib/cracklib/releases/download/v2.9.8/cracklib-words-2.9.8.bz2"
