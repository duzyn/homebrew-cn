class LlvmAT11 < Formula
  ...
  url "https://ghproxy.com/github.com/llvm/llvm-project/releases/download/llvmorg-11.1.0/llvm-project-11.1.0.src.tar.xz"
  ...
  patch do
    url "https://ghproxy.com/raw.githubusercontent.com/Homebrew/formula-patches/6166a68c/llvm/openmp_arm.patch"
