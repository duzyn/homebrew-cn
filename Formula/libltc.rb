class Libltc < Formula
  ...
  url "https://ghproxy.com/github.com/x42/libltc/releases/download/v1.3.2/libltc-1.3.2.tar.gz"
  ...
  test do
    (testpath/"test.c").write <<~EOS
      ...
      // https://ghproxy.com/raw.githubusercontent.com/x42/libltc/87d45b3/tests/example_encode.c
      #include <stdio.h>
      #include <stdlib.h>
      #include <string.h>
      #include <ltc.h>
