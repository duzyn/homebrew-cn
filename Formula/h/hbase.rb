class Hbase < Formula
  ...
  url "https://www.apache.org/dyn/closer.lua?path=hbase/2.5.8/hbase-2.5.8-bin.tar.gz"
  mirror "https://archive.apache.org/dist/hbase/2.5.8/hbase-2.5.8-bin.tar.gz"
