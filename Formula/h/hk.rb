class Hk < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/jdx/hk/archive/refs/tags/v0.6.5.tar.gz"
  ...
  test do
    ...
    (testpath/"hk.pkl").write <<~PKL
      amends "package://mirror.ghproxy.com/https://github.com/jdx/hk/releases/download/v#{version}/hk@#{version}#/Config.pkl"
      import "package://mirror.ghproxy.com/https://github.com/jdx/hk/releases/download/v#{version}/hk@#{version}#/builtins/cargo_clippy.pkl"
