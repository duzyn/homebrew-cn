class Hk < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/jdx/hk/archive/refs/tags/v1.15.3.tar.gz"
  ...
  resource "clx" do
    url "https://mirror.ghproxy.com/https://github.com/jdx/clx/archive/refs/tags/v0.2.19.tar.gz"
    sha256 "b06f39d4f74fb93a4be89152ee87a3c04a25abb1b623466c6b817427a8502a73"
  end

  resource "ensembler" do
    url "https://mirror.ghproxy.com/https://github.com/jdx/ensembler/archive/refs/tags/v0.2.11.tar.gz"
    sha256 "967f98f6dfd19b19e0aa91808ea5b81902d3cd6da254d0fdf10ffbaa756e22bb"
  end

  resource "xx" do
    url "https://mirror.ghproxy.com/https://github.com/jdx/xx/archive/refs/tags/v2.1.3.tar.gz"
