class Hk < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/jdx/hk/archive/refs/tags/v0.7.0.tar.gz"
  ...
  test do
    ...
    (testpath/"hk.pkl").write <<~PKL
      ...
      import "package://mirror.ghproxy.com/https://github.com/jdx/hk/releases/download/v#{version}/hk@#{version}#/builtins.pkl"
