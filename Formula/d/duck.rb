class Duck < Formula
  ...
  resource "jna" do
    url "https://mirror.ghproxy.com/https://github.com/java-native-access/jna/archive/refs/tags/5.18.1.tar.gz"
    sha256 "9af4d468a8b94def8c08761780766e919a0806d636b4c2ac55be0afe94cb8bb9"
  end

  resource "rococoa" do
    url "https://mirror.ghproxy.com/https://github.com/iterate-ch/rococoa/archive/refs/tags/0.10.0.tar.gz"
