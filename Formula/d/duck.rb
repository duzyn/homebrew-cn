class Duck < Formula
  ...
  resource "jna" do
    url "https://mirror.ghproxy.com/https://github.com/java-native-access/jna/archive/refs/tags/5.13.0.tar.gz"
    sha256 "526bff8ffcbc2067a7403f55b01ad8d7a781c098abca79c4ea6c9e80198bb5fd"
  end

  resource "rococoa" do
    url "https://mirror.ghproxy.com/https://github.com/iterate-ch/rococoa/archive/refs/tags/0.9.1.tar.gz"
