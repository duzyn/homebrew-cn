class Dashing < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/technosophos/dashing/archive/refs/tags/0.4.0.tar.gz"
  ...
  resource "redux_saga_docs_tarball" do
    url "https://mirror.ghproxy.com/https://github.com/dmitrytut/redux-saga-docset/archive/7df9e3070934c0f4b92d66d2165312bf78ecd6a0.tar.gz"
