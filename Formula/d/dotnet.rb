class Dotnet < Formula
  ...
  stable do
    ...
    url "https://mirror.ghproxy.com/https://github.com/dotnet/dotnet/archive/refs/tags/v9.0.3.tar.gz"
    sha256 "958522190b818b28ecbfbd62bbf1d9317653122ac58ecbacdad9a98b0c38fd2b"

    resource "release.json" do
      url "https://mirror.ghproxy.com/https://github.com/dotnet/dotnet/releases/download/v9.0.3/release.json"
