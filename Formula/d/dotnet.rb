class Dotnet < Formula
  ...
  stable do
    ...
    url "https://mirror.ghproxy.com/https://github.com/dotnet/dotnet/archive/refs/tags/v9.0.0.tar.gz"
    sha256 "ade10f909a684c2a056b8b0ec3a30e1570ce2b83c46c5f621a4464d02729af9f"

    resource "release.json" do
      url "https://mirror.ghproxy.com/https://github.com/dotnet/dotnet/releases/download/v9.0.0/release.json"
  ...
  test do
    ...
    resource "docfx" do
      url "https://mirror.ghproxy.com/https://github.com/dotnet/docfx/archive/refs/tags/v2.77.0.tar.gz"
