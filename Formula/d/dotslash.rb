class Dotslash < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/facebook/dotslash/archive/refs/tags/v0.5.7.tar.gz"
  ...
  test do
    (testpath/"node").write <<~EOS
      ...
      // The URLs in this file were taken from https://npmmirror.com/mirrors/node/v18.19.0/

      {
        ...
        "platforms": {
          "macos-aarch64": {
            ...
            "providers": [
              {
                "url": "https://npmmirror.com/mirrors/node/v18.19.0/node-v18.19.0-darwin-arm64.tar.gz"
              }
            ]
          },
          "macos-x86_64": {
            ...
            "providers": [
              {
                "url": "https://npmmirror.com/mirrors/node/v18.19.0/node-v18.19.0-darwin-x64.tar.gz"
              }
            ]
          },
          "linux-aarch64": {
            ...
            "providers": [
              {
                "url": "https://npmmirror.com/mirrors/node/v18.19.0/node-v18.19.0-linux-arm64.tar.gz"
              }
            ]
          },
          "linux-x86_64": {
            ...
            "providers": [
              {
                "url": "https://npmmirror.com/mirrors/node/v18.19.0/node-v18.19.0-linux-x64.tar.gz"
              }
            ]
          }
        }
