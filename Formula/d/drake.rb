class Drake < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/Factual/drake/archive/refs/tags/1.0.3.tar.gz"
  ...
  resource "jar" do
    url "https://mirror.ghproxy.com/https://github.com/Factual/drake/releases/download/1.0.3/drake.jar"
