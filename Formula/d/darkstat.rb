class Darkstat < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/emikulic/darkstat/archive/refs/tags/3.0.721.tar.gz"
  ...
  patch do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/homebrew-core/1cf441a0/Patches/darkstat/clock_gettime.patch"
