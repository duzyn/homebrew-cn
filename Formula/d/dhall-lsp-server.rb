class DhallLspServer < Formula
  ...
  stable do
    ...
    patch do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/039ff700fbd7682314f2ceb0dd0fcb0040e30c46/dhall-lsp-server/ghc-9.6.patch"
