class DocbookXsl < Formula
  ...
  patch do
    ...
    mirror "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/homebrew-core/1cf441a0/Patches/docbook-xsl/docbook-xsl-nons-1.79.2-stack_fix-1.patch"
