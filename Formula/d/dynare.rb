class Dynare < Formula
  ...
  on_macos do
    ...
    patch do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/homebrew-core/c49717c390cb2e587793b2db757c1f445f096219/Patches/dynare/clang.diff"
  ...
  test do
    resource "statistics" do
      url "https://mirror.ghproxy.com/https://github.com/gnu-octave/statistics/archive/refs/tags/release-1.7.3.tar.gz", using: :nounzip
