class DirectxHeaders < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/microsoft/DirectX-Headers/archive/refs/tags/v1.616.0.tar.gz"
  ...
  test do
    resource "test.cpp" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/microsoft/DirectX-Headers/a7d19030b872967c4224607c454273a2e65a5ed4/test/test.cpp"
