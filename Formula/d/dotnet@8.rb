class DotnetAT8 < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/dotnet/dotnet/archive/refs/tags/v8.0.18.tar.gz"
  ...
  resource "release.json" do
    url "https://mirror.ghproxy.com/https://github.com/dotnet/dotnet/releases/download/v8.0.18/release.json"
