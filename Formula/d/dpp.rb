class Dpp < Formula
  ...
  # VERSION=#{version} && curl https://mirror.ghproxy.com/https://raw.githubusercontent.com/atilaneves/dpp/v$VERSION/dub.selections.json
  resource "libclang" do
    ...
    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/atilaneves/dpp/refs/tags/v#{LATEST_VERSION}/dub.selections.json"
