class Dmd < Formula
  ...
  stable do
    ...
    url "https://mirror.ghproxy.com/https://github.com/dlang/dmd/archive/refs/tags/v2.108.1.tar.gz"
    sha256 "470eb1289578e179525f922be88003d5ed231000b8ab12c27b8e75034d77fcb7"

    resource "phobos" do
      url "https://mirror.ghproxy.com/https://github.com/dlang/phobos/archive/refs/tags/v2.108.1.tar.gz"
