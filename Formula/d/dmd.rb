class Dmd < Formula
  ...
  stable do
    ...
    url "https://mirror.ghproxy.com/https://github.com/dlang/dmd/archive/refs/tags/v2.106.0.tar.gz"
    sha256 "1079649c41a9b8e0d3e81c573c82d84cd6873b3afc95b37d6f5206842cedc7c9"

    resource "phobos" do
      url "https://mirror.ghproxy.com/https://github.com/dlang/phobos/archive/refs/tags/v2.106.0.tar.gz"
