class Stanc3 < Formula
  ...
  on_sequoia :or_newer do
    on_arm do
      resource "base" do
        url "https://mirror.ghproxy.com/https://github.com/janestreet/base/archive/refs/tags/v0.16.4.tar.gz"
  ...
  test do
    resource "homebrew-testfile" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/stan-dev/stanc3/2e833ac746a36cdde11b7041fe3a1771dec92ba6/test/integration/good/algebra_solver_good.stan"
