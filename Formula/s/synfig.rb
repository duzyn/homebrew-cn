class Synfig < Formula
  ...
  url "https://downloads.sourceforge.net/project/synfig/development/1.5.2/source/synfig-1.5.2.tar.gz?use_mirror=jaist"
  mirror "https://mirror.ghproxy.com/https://github.com/synfig/synfig/releases/download/v1.5.2/synfig-1.5.2.tar.gz"
