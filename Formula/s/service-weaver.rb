class ServiceWeaver < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/ServiceWeaver/weaver/archive/refs/tags/v0.23.0.tar.gz"
    sha256 "c74a7ee8c99b7fef141e876114e24323780c67f73b0c4770d9a1e2e053e02469"

    resource "weaver-gke" do
      url "https://mirror.ghproxy.com/https://github.com/ServiceWeaver/weaver-gke/archive/refs/tags/v0.23.0.tar.gz"
