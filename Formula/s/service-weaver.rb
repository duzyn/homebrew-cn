class ServiceWeaver < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/ServiceWeaver/weaver/archive/refs/tags/v0.24.4.tar.gz"
    sha256 "00e1f434b0521a25fe205d2eb78490f6e8a13f15fdc989d4d8e26f2f50e21ff1"

    resource "weaver-gke" do
      url "https://mirror.ghproxy.com/https://github.com/ServiceWeaver/weaver-gke/archive/refs/tags/v0.24.3.tar.gz"
