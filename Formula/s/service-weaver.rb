class ServiceWeaver < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/ServiceWeaver/weaver/archive/refs/tags/v0.23.1.tar.gz"
    sha256 "b7025fc124ab20d7a50be4eb437bd6989139d68e0f1bc4ccc2552dbaa5ef6c6c"

    resource "weaver-gke" do
      url "https://mirror.ghproxy.com/https://github.com/ServiceWeaver/weaver-gke/archive/refs/tags/v0.23.5.tar.gz"
