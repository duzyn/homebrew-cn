class ServiceWeaver < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/ServiceWeaver/weaver/archive/refs/tags/v0.24.6.tar.gz"
    sha256 "15b34f1539b6a84f8783009a2e8ce98bb12c9a0c0ba70b4ff055e4a8a3406e10"

    resource "weaver-gke" do
      url "https://mirror.ghproxy.com/https://github.com/ServiceWeaver/weaver-gke/archive/refs/tags/v0.24.4.tar.gz"
