class ServiceWeaver < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/ServiceWeaver/weaver/archive/refs/tags/v0.23.2.tar.gz"
    sha256 "9ffc9fa3497d3453ff1c684e2c6f80f9b2874c11896ff6679b515a6cf7a2396d"

    resource "weaver-gke" do
      url "https://mirror.ghproxy.com/https://github.com/ServiceWeaver/weaver-gke/archive/refs/tags/v0.23.6.tar.gz"
