class Swift < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/apple/swift/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
  ...
  on_linux do
    ...
    resource "swift-corelibs-foundation" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-corelibs-foundation/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
      sha256 "e58c529ababd547cf0b205fc0820ccce38a033664625c271110b564f2554dd44"
    end

    resource "swift-corelibs-libdispatch" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-corelibs-libdispatch/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
      sha256 "b1f3e46ed248df6a3456d20bc23b2d8a12b740a40185d81b668b1d31735cadf2"
    end

    resource "swift-corelibs-xctest" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-corelibs-xctest/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
  ...
  resource "llvm-project" do
    url "https://mirror.ghproxy.com/https://github.com/apple/llvm-project/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
  ...
  resource "cmark" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-cmark/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
    sha256 "658f4eb94f271e68af4ae07f4214f58d36dfc8edd7fc17ac44e8c85bec984337"
  end

  resource "llbuild" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-llbuild/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
  ...
  resource "swiftpm" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-package-manager/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
    sha256 "132ae4908fa9c8f10265585f593dc748a021a18b11d6a1881e22d2db2dd1e162"
  end

  resource "indexstore-db" do
    url "https://mirror.ghproxy.com/https://github.com/apple/indexstore-db/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
    sha256 "a907c8fce27e718c179f6a92b73df62675e44b86612116468ff6ebd3f2997b31"
  end

  resource "sourcekit-lsp" do
    url "https://mirror.ghproxy.com/https://github.com/apple/sourcekit-lsp/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
    sha256 "0db3e5c56f2889a3be2ff4e9b5a285085459dee6f821c0cdf513eb5c9cc94ae4"
  end

  resource "swift-driver" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-driver/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
    sha256 "e4db5194e99ebbd605a14b86965b301b5a060482ecd1c5c94a4a099de5754e35"
  end

  resource "swift-tools-support-core" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-tools-support-core/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
  ...
  resource "swift-docc" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-docc/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
    sha256 "5c2f2a68280d476b0d5559b38ffd46cb2f04d3d2e7436d9e2ddccf6555a9888f"
  end

  resource "swift-lmdb" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-lmdb/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
    sha256 "0bafb61c6d8924626a9b130f3bcf9b92139f52a86aa1fa04539b83bc668c4b58"
  end

  resource "swift-docc-render-artifact" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-docc-render-artifact/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
    sha256 "be134a7655345544eec00b52d097f4ca4a88333b17d32f3fb72f367aca335f96"
  end

  resource "swift-docc-symbolkit" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-docc-symbolkit/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
    sha256 "fb95cecf2de170066d9529dafe0a74781b94c4262891e4f0751693662c48e30d"
  end

  resource "swift-markdown" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-markdown/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
    sha256 "5b00363c4704e8b77bf78f127a734cfaf6fcda9e8898f3340fc4c8745e37e2c5"
  end

  resource "swift-experimental-string-processing" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-experimental-string-processing/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
    sha256 "3abc4225789e19defae966f7d9a712c77a5c0366f1d44d37df671048fe62daf6"
  end

  resource "swift-syntax" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-syntax/archive/refs/tags/swift-5.9.2-RELEASE.tar.gz"
  ...
  resource "swift-argument-parser" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-argument-parser/archive/refs/tags/1.2.2.tar.gz"
  ...
  resource "swift-atomics" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-atomics/archive/refs/tags/1.0.2.tar.gz"
    sha256 "c8b88186db4902dc5109340f4a745ea787cb2aa9533c7e6d1e634549f9e527b1"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-collections" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-collections/archive/refs/tags/1.0.1.tar.gz"
    sha256 "575cf0f88d9068411f9acc6e3ca5d542bef1cc9e87dc5d69f7b5a1d5aec8c6b6"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-crypto" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-crypto/archive/refs/tags/2.5.0.tar.gz"
    sha256 "a7b2f5c4887ccd728cdff5d1162b4d4d36bd6c2df9c0c31d5b9b73d341c5c1bb"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-certificates" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-certificates/archive/refs/tags/0.4.1.tar.gz"
    sha256 "d7699ce91d65a622c1b9aaa0235cbbbd1be4ddc42a90fce007ff74bef50e8985"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-asn1" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-asn1/archive/refs/tags/0.7.0.tar.gz"
    sha256 "d4470d61788194abbd60ed73965ee0722cc25037e83d41226a8a780088ba524e"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-numerics" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-numerics/archive/refs/tags/1.0.1.tar.gz"
    sha256 "3ff05bb89c907d70f51dfff794ea3354a2630488925bf53382246d25089ec742"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-system" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-system/archive/refs/tags/1.1.1.tar.gz"
    sha256 "865b8c380455eef27e73109835142920c60ae4c4f4178a3d12ad04acc83f1371"
  end

  # As above: refer to update-checkout-config.json
  resource "yams" do
    url "https://mirror.ghproxy.com/https://github.com/jpsim/Yams/archive/refs/tags/5.0.1.tar.gz"
