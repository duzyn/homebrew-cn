class Swift < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
  ...
  on_linux do
    ...
    resource "swift-corelibs-foundation" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-corelibs-foundation/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
      sha256 "66c27bb9fc2d8886902fac20d38e1645d4de3329089414ccc833296341a71b99"
    end

    resource "swift-foundation" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-foundation/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
    ...
    resource "swift-foundation-icu" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-foundation-icu/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
      sha256 "d223d31f2d37da7ec10c0c580e648e70cc448a41fb7e23b8b60aaaf3c5f03a8b"
    end

    resource "swift-corelibs-libdispatch" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-corelibs-libdispatch/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
      sha256 "150066ba341e49b8518a0b879ba82941d6d8734ab37cb76683f2a155369e5030"
    end

    resource "swift-corelibs-xctest" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-corelibs-xctest/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
  ...
  resource "llvm-project" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/llvm-project/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
    sha256 "8f026177a2378e4fc141e9284a5b4567b92cd50070e29a3eab5cabb8252aa72a"
  end

  resource "cmark" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-cmark/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
    sha256 "9d295dcd09fd4fd7110545cd097ec4ad36309c1138bac161414a2c98c2531621"
  end

  resource "llbuild" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-llbuild/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
    ...
    patch do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/0080c7317c51d16b17671640c5db665516402d2f/swift/llbuild-sqlite3.patch"
      sha256 "97329a525dabf4a7a13d3e3237965e66ae456887776e0101e82b6ca125a97591"
    end
  end

  resource "swiftpm" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-package-manager/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
    sha256 "71e5713adfef574d0d9de0299edc313714c1fc73fe0ea7d1e11c26b61f98006d"
  end

  resource "indexstore-db" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/indexstore-db/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
  ...
  resource "sourcekit-lsp" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/sourcekit-lsp/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
    sha256 "11f585fe36cc2bc055feb82e8de2e58ce2dba51ce31e67a884a7cf3a4307c0ca"
  end

  resource "swift-driver" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-driver/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
    sha256 "1375ef1e37c10e9de7f09379cd3150a64537e11b399794e7e9d68037ae5709f8"
  end

  resource "swift-tools-support-core" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-tools-support-core/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
  ...
  resource "swift-docc" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-docc/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
    sha256 "4f1de0f06f89faa3fe803cf593394992e6146d20b1871b7ed9cd8e7943f0846d"
  end

  resource "swift-lmdb" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-lmdb/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
    sha256 "2becae3a09421421d6c482de43c926a9aee3b3c6a84e86a1f418d01bce6f9ed8"
  end

  resource "swift-docc-render-artifact" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-docc-render-artifact/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
    sha256 "52b8c83fe8cff9a512170bd9db2ffc944e7effe62d069b1b7c6ab665e2f40091"
  end

  resource "swift-docc-symbolkit" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-docc-symbolkit/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
    sha256 "f99e0ac5c12f744bdb56201e54364ce3c49b671d97e2acb887fea2916b598b18"
  end

  resource "swift-markdown" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-markdown/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
    sha256 "49e2e75c6c6ec97fbaae7ce90f105230a6c7dca56e43f2fd043561deba6e4760"
  end

  resource "swift-experimental-string-processing" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-experimental-string-processing/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
    sha256 "0242e75b1a7ea4f7135bc73b64e014288ad37c637273b8ab0b1086b1d6f07ef0"
  end

  resource "swift-syntax" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-syntax/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
    sha256 "7384e064368b7c172477292d64adb08e0609e9aa8d89b1e6a39537487557e015"
  end

  resource "swift-testing" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-testing/archive/refs/tags/swift-6.0.1-RELEASE.tar.gz"
  ...
  resource "swift-argument-parser" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-argument-parser/archive/refs/tags/1.2.3.tar.gz"
  ...
  resource "swift-collections" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-collections/archive/refs/tags/1.1.2.tar.gz"
  ...
  resource "swift-system" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-system/archive/refs/tags/1.3.0.tar.gz"
    sha256 "02e13a7f77887c387f5aa1de05f4d4b8b158c35145450e1d9557d6c42b06cd1f"
  end

  # As above: refer to update-checkout-config.json
  resource "yams" do
    url "https://mirror.ghproxy.com/https://github.com/jpsim/Yams/archive/refs/tags/5.0.6.tar.gz"
    sha256 "a81c6b93f5d26bae1b619b7f8babbfe7c8abacf95b85916961d488888df886fb"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-nio" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-nio/archive/refs/tags/2.31.2.tar.gz"
    sha256 "8818b8e991d36e886b207ae1023fa43c5eada7d6a1951a52ad70f7f71f57d9fe"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-nio-ssl" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-nio-ssl/archive/refs/tags/2.15.0.tar.gz"
