class Swift < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  on_linux do
    ...
    resource "swift-corelibs-foundation" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-corelibs-foundation/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
    ...
    resource "swift-foundation" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-foundation/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
    ...
    resource "swift-foundation-icu" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-foundation-icu/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
    ...
    resource "swift-corelibs-libdispatch" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-corelibs-libdispatch/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
    ...
    resource "swift-corelibs-xctest" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-corelibs-xctest/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "llvm-project" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/llvm-project/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "cmark" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-cmark/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "llbuild" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-llbuild/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
    ...
    patch do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/0259d63a476200df801e400955e7a6f98a0ebb0e/swift/llbuild-sqlite3.patch"
      sha256 "184ce34784c532ec72d71673218fedb72dc09fdff13fd94c2331e1696d329def"
    end
  end

  resource "swift-build" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-build/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "swiftpm" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-package-manager/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
    ...
    patch do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/0259d63a476200df801e400955e7a6f98a0ebb0e/swift/swiftpm-sqlite3.patch"
      sha256 "78a13abd5a301a3172c3c72ad19a5f1bcfd6c7f142ee90b9417124923dbdd6d1"
    end
  end

  resource "indexstore-db" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/indexstore-db/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "sourcekit-lsp" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/sourcekit-lsp/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "swift-driver" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-driver/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "swift-tools-support-core" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-tools-support-core/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "swift-docc" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-docc/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "swift-lmdb" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-lmdb/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "swift-docc-render-artifact" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-docc-render-artifact/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "swift-docc-symbolkit" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-docc-symbolkit/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "swift-markdown" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-markdown/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "swift-experimental-string-processing" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-experimental-string-processing/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "swift-syntax" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-syntax/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "swift-testing" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-testing/archive/refs/tags/swift-6.2-RELEASE.tar.gz"
  ...
  resource "swift-argument-parser" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-argument-parser/archive/refs/tags/1.4.0.tar.gz"
  ...
  resource "swift-atomics" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-atomics/archive/refs/tags/1.2.0.tar.gz"
    sha256 "33d9f4fbaeddee4bda3af2be126791ee8acf3d3c24a2244457641a20d39aec12"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-collections" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-collections/archive/refs/tags/1.1.3.tar.gz"
    sha256 "7e5e48d0dc2350bed5919be5cf60c485e72a30bd1f2baf718a619317677b91db"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-crypto" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-crypto/archive/refs/tags/3.0.0.tar.gz"
    sha256 "5c860c0306d0393ff06268f361aaf958656e1288353a0e23c3ad20de04319154"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-certificates" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-certificates/archive/refs/tags/1.0.1.tar.gz"
    sha256 "fcaca458aab45ee69b0f678b72c2194b15664cc5f6f5e48d0e3f62bc5d1202ca"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-asn1" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-asn1/archive/refs/tags/1.0.0.tar.gz"
    sha256 "e0da995ae53e6fcf8251887f44d4030f6600e2f8f8451d9c92fcaf52b41b6c35"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-numerics" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-numerics/archive/refs/tags/1.0.2.tar.gz"
    sha256 "786291c6ff2a83567928d3d8f964c43ff59bdde215f9dedd0e9ed49eb5184e59"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-system" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-system/archive/refs/tags/1.5.0.tar.gz"
    sha256 "4bf5d5db04d48f484289371b63dd7bdced0db1ab1307c49127b9f894341a521d"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-nio" do
    url "https://mirror.ghproxy.com/https://github.com/apple/swift-nio/archive/refs/tags/2.65.0.tar.gz"
    sha256 "feb16b6d0e6d010be14c6732d7b02ddbbdc15a22e3912903f08ef5d73928f90d"
  end

  # As above: refer to update-checkout-config.json
  resource "swift-toolchain-sqlite" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-toolchain-sqlite/archive/refs/tags/1.0.1.tar.gz"
  ...
  patch do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/5e4d9bb4d04c7c9004e95fecba362a843dc00bdd/swift/homebrew-resource-dir.diff"
