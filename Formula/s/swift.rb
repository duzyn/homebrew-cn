class Swift < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
  ...
  on_linux do
    ...
    resource "swift-corelibs-foundation" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-corelibs-foundation/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
      sha256 "8af719f14a05cee2d32625cf455261fc74d13eeef3ba9e5b9547316743d5cde9"
    end

    resource "swift-foundation" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-foundation/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
      sha256 "a677ad3a712fb4d8330bccd28904aaa1b10749264d57ad9370215a89156ba1d3"
    end

    resource "swift-foundation-icu" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-foundation-icu/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
      sha256 "a48f0d6f998ba6db710f89f0e987c4cf00f3845338afae116ab3e29c04dad127"
    end

    resource "swift-corelibs-libdispatch" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-corelibs-libdispatch/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
      sha256 "3df429b22d9294c0ca5291c86e83a35f6326600a1c271933107bba199b919008"
    end

    resource "swift-corelibs-xctest" do
      url "https://mirror.ghproxy.com/https://github.com/apple/swift-corelibs-xctest/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
  ...
  resource "llvm-project" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/llvm-project/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
  ...
  resource "cmark" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-cmark/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
    sha256 "2bfeab8747f4bcfea6aa70ed0494fe2185ec2532f1c9b7a0e17214cd401e9f31"
  end

  resource "llbuild" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-llbuild/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
  ...
  resource "swiftpm" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-package-manager/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
    sha256 "00e40c3bce9b63fdd24d783909af003c7f86431898ee6b8bf44174d023d08402"
  end

  resource "indexstore-db" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/indexstore-db/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
  ...
  resource "sourcekit-lsp" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/sourcekit-lsp/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
    sha256 "26175c4774f9817ad32c62c004ca76e9f09d8b77a253fca0e4eafdb33f33b2d2"
  end

  resource "swift-driver" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-driver/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
    sha256 "c6db9d058c8d5122f8e368087e397d59cf17ce5be686d4713025269658f0467e"
  end

  resource "swift-tools-support-core" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-tools-support-core/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
  ...
  resource "swift-docc" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-docc/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
    sha256 "2fa482d6a3ba09a6bbdd9a503ae20a425e495c0c955dc2bd8ebafa64b38ca8ba"
  end

  resource "swift-lmdb" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-lmdb/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
    sha256 "384ce2942dbff106d6cca112b3f9a00be0ce3715a33c7b0b81dc61cc722ffdcd"
  end

  resource "swift-docc-render-artifact" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-docc-render-artifact/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
    sha256 "7411ed38dcb5a783ddd5c557290a7c2b939251a2ce634913a96a80b8a66c8c0c"
  end

  resource "swift-docc-symbolkit" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-docc-symbolkit/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
    sha256 "a310e60e64291fe8204b59b50c68d1e66bec3eb837ac8a5af8700ad09c819b1d"
  end

  resource "swift-markdown" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-markdown/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
    sha256 "7fedb25982044af33747162f1f249be279f26a043c96d7c4f2b20dcc3d689bdc"
  end

  resource "swift-experimental-string-processing" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-experimental-string-processing/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
    sha256 "e0380895e1cf5dc49aef321256f8192986185a6fa6ea83c143f171b643450fc0"
  end

  resource "swift-syntax" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-syntax/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
    sha256 "82cb7640775a23cf7483197f0cd6a6342a29a61d4bb75239905490bf47a64a75"
  end

  resource "swift-testing" do
    url "https://mirror.ghproxy.com/https://github.com/swiftlang/swift-testing/archive/refs/tags/swift-6.0.2-RELEASE.tar.gz"
