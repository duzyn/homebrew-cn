class Snort < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/snort3/snort3/archive/refs/tags/3.1.83.0.tar.gz"
  mirror "https://fossies.org/linux/misc/snort3-3.1.83.0.tar.gz"
