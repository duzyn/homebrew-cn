class Shaderc < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/google/shaderc/archive/refs/tags/v2026.1.tar.gz"
    ...
    resource "glslang" do
      ...
      livecheck do
        url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/google/shaderc/refs/tags/v#{LATEST_VERSION}/DEPS"
