class Sysdig < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/draios/sysdig/archive/refs/tags/0.38.1.tar.gz"
    ...
    # VERSION=#{version} && curl -fsSL https://mirror.ghproxy.com/https://raw.githubusercontent.com/draios/sysdig/$VERSION/cmake/modules/falcosecurity-libs.cmake | grep -o 'set(FALCOSECURITY_LIBS_VERSION "[0-9.]*")' | awk -F'"' '{print $2}'
    resource "falcosecurity-libs" do
      url "https://mirror.ghproxy.com/https://github.com/falcosecurity/libs/archive/refs/tags/0.17.2.tar.gz"
