class Step < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/smallstep/cli/releases/download/v0.27.1/step_0.27.1.tar.gz"
  ...
  resource "certificates" do
    url "https://mirror.ghproxy.com/https://github.com/smallstep/certificates/releases/download/v0.27.0/step-ca_0.27.0.tar.gz"
