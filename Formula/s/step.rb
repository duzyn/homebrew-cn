class Step < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/smallstep/cli/releases/download/v0.28.0/step_0.28.0.tar.gz"
  ...
  resource "certificates" do
    url "https://mirror.ghproxy.com/https://github.com/smallstep/certificates/releases/download/v0.28.0/step-ca_0.28.0.tar.gz"
