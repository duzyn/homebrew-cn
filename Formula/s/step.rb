class Step < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/smallstep/cli/releases/download/v0.28.3/step_0.28.3.tar.gz"
  ...
  resource "certificates" do
    url "https://mirror.ghproxy.com/https://github.com/smallstep/certificates/releases/download/v0.28.1/step-ca_0.28.1.tar.gz"
