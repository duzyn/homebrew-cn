class Stringtie < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/gpertea/stringtie/archive/refs/tags/v3.0.1.tar.gz"
  ...
  test do
    resource "homebrew-test" do
      url "https://mirror.ghproxy.com/https://github.com/gpertea/stringtie/raw/test_data/tests.tar.gz"
