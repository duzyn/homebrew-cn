class Simdutf < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/simdutf/simdutf/archive/refs/tags/v5.3.0.tar.gz"
  ...
  # VERSION=#{version} && curl -s https://mirror.ghproxy.com/https://raw.githubusercontent.com/simdutf/simdutf/v$VERSION/benchmarks/base64/CMakeLists.txt | grep -C 1 'name = "VERSION"'
  resource "base64" do
