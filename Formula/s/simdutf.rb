class Simdutf < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/simdutf/simdutf/archive/refs/tags/v7.5.0.tar.gz"
  ...
  resource "base64" do
    ...
    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/simdutf/simdutf/v#{LATEST_VERSION}/benchmarks/base64/CMakeLists.txt"
      regex(/VERSION\s+(\d+(?:\.\d+)+)/)
    end
  end
