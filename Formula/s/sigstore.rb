class Sigstore < Formula
  ...
  test do
    ...
    resource "homebrew-test-artifact" do
      url "https://mirror.ghproxy.com/https://github.com/sigstore/sigstore-python/releases/download/v2.1.3/sigstore-2.1.3.tar.gz", using: :nounzip
      sha256 "7a0c1252cb7974024aee87c8e0f0f6247604af16e8b5a8e3d0a9e1201e330aa2"
    end

    resource "homebrew-test-artifact.sigstore" do
      url "https://mirror.ghproxy.com/https://github.com/sigstore/sigstore-python/releases/download/v2.1.3/sigstore-2.1.3.tar.gz.sigstore"
