class Sigstore < Formula
  ...
  test do
    ...
    resource "homebrew-test-artifact" do
      url "https://mirror.ghproxy.com/https://github.com/sigstore/sigstore-python/releases/download/v3.0.0/sigstore-3.0.0.tar.gz", using: :nounzip
      sha256 "a6a9538a648e112a0c3d8092d3f73a351c7598164764f1e73a6b5ba406a3a0bd"
    end

    resource "homebrew-test-artifact.sigstore" do
      url "https://mirror.ghproxy.com/https://github.com/sigstore/sigstore-python/releases/download/v3.0.0/sigstore-3.0.0.tar.gz.sigstore"
