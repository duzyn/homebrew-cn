class Sigstore < Formula
  ...
  test do
    ...
    resource "homebrew-test-artifact" do
      url "https://mirror.ghproxy.com/https://github.com/sigstore/sigstore-python/releases/download/v3.2.0/sigstore-3.2.0.tar.gz", using: :nounzip
      sha256 "25c8a871a3a6adf959c0cde598ea8bef8794f1a29277d067111eb4ded4ba7f65"
    end

    resource "homebrew-test-artifact.sigstore" do
      url "https://mirror.ghproxy.com/https://github.com/sigstore/sigstore-python/releases/download/v3.2.0/sigstore-3.2.0.tar.gz.sigstore"
