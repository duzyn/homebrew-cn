class Sigstore < Formula
  ...
  test do
    ...
    resource "homebrew-test-artifact" do
      url "https://mirror.ghproxy.com/https://github.com/sigstore/sigstore-python/releases/download/v3.1.0/sigstore-3.1.0.tar.gz", using: :nounzip
      sha256 "cc0b52acff3ae25f7f1993e21dec4ebed44213c48e2ec095e8c06f69b3751fdf"
    end

    resource "homebrew-test-artifact.sigstore" do
      url "https://mirror.ghproxy.com/https://github.com/sigstore/sigstore-python/releases/download/v3.1.0/sigstore-3.1.0.tar.gz.sigstore"
