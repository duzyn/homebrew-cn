class Sigstore < Formula
  ...
  test do
    ...
    resource "homebrew-test-artifact" do
      url "https://mirror.ghproxy.com/https://github.com/sigstore/sigstore-python/releases/download/v2.1.2/sigstore-2.1.2.tar.gz", using: :nounzip
      sha256 "94139c1efa0784135516d11b79c8b06d4ea61245624e69cda44494e87560b07c"
    end

    resource "homebrew-test-artifact.sigstore" do
      url "https://mirror.ghproxy.com/https://github.com/sigstore/sigstore-python/releases/download/v2.1.2/sigstore-2.1.2.tar.gz.sigstore"
