class Scrcpy < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/Genymobile/scrcpy/archive/refs/tags/v3.0.2.tar.gz"
  ...
  resource "prebuilt-server" do
    url "https://mirror.ghproxy.com/https://github.com/Genymobile/scrcpy/releases/download/v3.0.2/scrcpy-server-v3.0.2", using: :nounzip
