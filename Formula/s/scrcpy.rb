class Scrcpy < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/Genymobile/scrcpy/archive/refs/tags/v2.6.tar.gz"
  ...
  resource "prebuilt-server" do
    url "https://mirror.ghproxy.com/https://github.com/Genymobile/scrcpy/releases/download/v2.6/scrcpy-server-v2.6"
