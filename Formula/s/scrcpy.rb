class Scrcpy < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/Genymobile/scrcpy/archive/refs/tags/v2.3.1.tar.gz"
  ...
  resource "prebuilt-server" do
    url "https://mirror.ghproxy.com/https://github.com/Genymobile/scrcpy/releases/download/v2.3.1/scrcpy-server-v2.3.1"
