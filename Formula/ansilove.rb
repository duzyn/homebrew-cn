class Ansilove < Formula
  ...
  url "https://ghproxy.com/github.com/ansilove/ansilove/releases/download/4.1.6/ansilove-4.1.6.tar.gz"
  ...
  resource "libansilove" do
    url "https://ghproxy.com/github.com/ansilove/libansilove/releases/download/1.2.9/libansilove-1.2.9.tar.gz"
