class Influxdb < Formula
  ...
  resource "pkg-config-wrapper" do
    ...
    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/influxdata/influxdb/v#{LATEST_VERSION}/go.mod"
  ...
  resource "ui-assets" do
    url "https://mirror.ghproxy.com/https://github.com/influxdata/ui/releases/download/OSS-2.7.8/build.tar.gz"
    sha256 "28ace1df37b7860b011e5c1b8c74830b0ec584d2f86c24e58a7c855c168f58a8"

    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/influxdata/influxdb/v#{LATEST_VERSION}/scripts/fetch-ui-assets.sh"
  ...
  patch do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/a188defd190459f5d1faa8c8f9e253e8f83ca161/influxdb/2.7.11-rust-1.83.patch"
