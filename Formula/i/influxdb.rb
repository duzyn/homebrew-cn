class Influxdb < Formula
  ...
  resource "pkg-config-wrapper" do
    url "https://mirror.ghproxy.com/https://github.com/influxdata/pkg-config/archive/refs/tags/v0.2.14.tar.gz"
  ...
  resource "ui-assets" do
    url "https://mirror.ghproxy.com/https://github.com/influxdata/ui/releases/download/OSS-v2.7.12/build.tar.gz"
