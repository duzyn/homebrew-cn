class Ibazel < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/bazelbuild/bazel-watcher/archive/refs/tags/v0.24.0.tar.gz"
  ...
  test do
    ...
    (testpath/"WORKSPACE").write <<~EOS
      ...
      http_archive(
        ...
        urls = [
            "https://mirror.bazel.build/mirror.ghproxy.com/https://github.com/bazelbuild/rules_go/releases/download/v0.41.0/rules_go-v0.41.0.zip",
            "https://mirror.ghproxy.com/https://github.com/bazelbuild/rules_go/releases/download/v0.41.0/rules_go-v0.41.0.zip",
        ],
      )
