class Zrepl < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/zrepl/zrepl/archive/refs/tags/v0.6.1.tar.gz"
  ...
  resource "homebrew-sample_config" do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/zrepl/zrepl/refs/tags/v0.6.1/config/samples/local.yml"
