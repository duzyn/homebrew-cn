class ZlibRs < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/trifectatechfoundation/zlib-rs/archive/refs/tags/v0.6.2.tar.gz"
  ...
  test do
    ...
    resource "zpipe.c" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/trifectatechfoundation/zlib-rs/refs/tags/v0.6.2/libz-rs-sys-cdylib/zpipe.c"
