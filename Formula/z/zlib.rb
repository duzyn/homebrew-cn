class Zlib < Formula
  ...
  mirror "https://downloads.sourceforge.net/project/libpng/zlib/1.3.1/zlib-1.3.1.tar.gz?use_mirror=jaist"
  ...
  test do
    ...
    resource "zpipe.c" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/madler/zlib/3f5d21e8f573a549ffc200e17dd95321db454aa1/examples/zpipe.c"
