class Cromwell < Formula
  ...
  url "https://ghproxy.com/github.com/broadinstitute/cromwell/releases/download/84/cromwell-84.jar"
  ...
  resource "womtool" do
    url "https://ghproxy.com/github.com/broadinstitute/cromwell/releases/download/84/womtool-84.jar"
