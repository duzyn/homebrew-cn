class Bsc < Formula
  ...
  stable do
    url "https://mirror.ghproxy.com/https://github.com/B-Lang-org/bsc/archive/refs/tags/2025.07.tar.gz"
    sha256 "5019721717ac27bf80a549ccdd0fadf57ac7fe08cfbd75b0de98569fa36780f7"

    resource "yices" do
      url "https://mirror.ghproxy.com/https://github.com/B-Lang-org/bsc/releases/download/2025.07/yices-src-for-bsc-2025.07.tar.gz", using: :nounzip
