class Breseq < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/barricklab/breseq/archive/refs/tags/v0.39.0.tar.gz"
  ...
  on_linux do
    ...
    patch do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Homebrew/homebrew-core/acbb0d0473a8bbb75ea7fbb471457a2127ef2c2d/Patches/breseq/zlib-ng.patch"
  ...
  test do
    resource "homebrew-test-gbk" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/barricklab/breseq/refs/tags/v0.39.0/tests/data/REL606/REL606.fragment.gbk"
      sha256 "0e6edf3df46da73db9d07622316e0b9617e7a95faf87589bb0a7bc2393e2d92e"
    end

    resource "homebrew-test-fastq" do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/barricklab/breseq/refs/tags/v0.39.0/tests/data/REL606/REL606.fragment.2.fastq"
