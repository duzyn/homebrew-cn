class Bazel < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/bazelbuild/bazel/releases/download/8.2.0/bazel-8.2.0-dist.zip"
  ...
  if DevelopmentTools.clang_build_version >= 1600
    ...
    resource "bazel-src" do
      url "https://mirror.ghproxy.com/https://github.com/bazelbuild/bazel/archive/refs/tags/8.2.0.tar.gz"
