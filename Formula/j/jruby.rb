class Jruby < Formula
  ...
  resource "jffi" do
    url "https://mirror.ghproxy.com/https://github.com/jnr/jffi/archive/refs/tags/jffi-1.3.14.tar.gz"
    sha256 "dfc120bc832cd81940fb785bef2987bd3f54199fddbed0e62145718d5a3d3b95"

    livecheck do
      url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/jruby/jruby/refs/tags/#{LATEST_VERSION}/pom.xml"
      strategy :xml do |xml|
