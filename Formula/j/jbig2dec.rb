class Jbig2dec < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/ArtifexSoftware/jbig2dec/archive/refs/tags/0.20.tar.gz"
  ...
  resource("test") do
    url "https://mirror.ghproxy.com/https://github.com/apache/tika/raw/master/tika-parsers/src/test/resources/test-documents/testJBIG2.jb2"
