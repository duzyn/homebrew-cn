class Jbig2dec < Formula
  ...
  url "https://ghproxy.com/github.com/ArtifexSoftware/ghostpdl-downloads/releases/download/gs9531/jbig2dec-0.19.tar.gz"
  ...
  resource("test") do
    url "https://ghproxy.com/github.com/apache/tika/raw/master/tika-parsers/src/test/resources/test-documents/testJBIG2.jb2"
