class Devd < Formula
  ...
  stable do
    ...
    resource "go.mod" do
      url "https://ghproxy.com/raw.githubusercontent.com/cortesi/devd/4ab3fc9061542fd35b5544627354e5755fa74c1c/go.mod"
      sha256 "483b4294205cf2dea2d68b8f99aefcf95aadac229abc2a299f4d1303f645e6b0"
    end
    resource "go.sum" do
      url "https://ghproxy.com/raw.githubusercontent.com/cortesi/devd/4ab3fc9061542fd35b5544627354e5755fa74c1c/go.sum"
