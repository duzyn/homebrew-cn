class Bupstash < Formula
  ...
  url "https://ghproxy.com/github.com/andrewchambers/bupstash/releases/download/v0.12.0/bupstash-v0.12.0-src+deps.tar.gz"
  ...
  resource "man" do
    url "https://ghproxy.com/github.com/andrewchambers/bupstash/releases/download/v0.12.0/bupstash-v0.12.0-man.tar.gz"
