class WasiLibc < Formula
  ...
  stable do
    ...
    url "https://mirror.ghproxy.com/https://github.com/WebAssembly/wasi-libc/archive/50ae11904df674fecaa311537967fe138c21fcc7.tar.gz"
    version "26"
    ...
    resource "WASI" do
      ...
      url "https://mirror.ghproxy.com/https://github.com/WebAssembly/WASI/archive/59cbe140561db52fc505555e859de884e0ee7f00.tar.gz"
  ...
  test do
    ...
    resource "builtins" do
      url "https://mirror.ghproxy.com/https://github.com/WebAssembly/wasi-sdk/releases/download/wasi-sdk-24/libclang_rt.builtins-wasm32-wasi-24.0.tar.gz"
