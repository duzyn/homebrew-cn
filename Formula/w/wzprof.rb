class Wzprof < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/dispatchrun/wzprof/archive/refs/tags/v0.2.0.tar.gz"
  ...
  test do
    resource "simple.wasm" do
      url "https://mirror.ghproxy.com/https://github.com/dispatchrun/wzprof/raw/c2e9f22/testdata/c/simple.wasm"
