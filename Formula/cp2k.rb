class Cp2k < Formula
  ...
  url "https://ghproxy.com/github.com/cp2k/cp2k/releases/download/v2022.2/cp2k-2022.2.tar.bz2"
  ...
  resource "libint" do
    url "https://ghproxy.com/github.com/cp2k/libint-cp2k/releases/download/v2.6.0/libint-v2.6.0-cp2k-lmax-5.tgz"
