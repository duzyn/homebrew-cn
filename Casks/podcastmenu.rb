cask "podcastmenu" do
  ...
  url "https://ghproxy.com/https://github.com/insidegui/PodcastMenu/raw/master/Releases/PodcastMenu_v#{version}.zip"
  name "PodcastMenu"
  desc "Tool to display Overcast on the menu bar"
  homepage "https://github.com/insidegui/PodcastMenu"

  livecheck do
    url "https://ghproxy.com/https://github.com/insidegui/PodcastMenu/raw/master/Releases/appcast.xml"
