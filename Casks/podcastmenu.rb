cask "podcastmenu" do
  ...
  url "https://ghproxy.com/github.com/insidegui/PodcastMenu/raw/master/Releases/PodcastMenu_v#{version.csv.first}.zip"
  name "PodcastMenu"
  desc "Tool to display Overcast on the menu bar"
  homepage "https://github.com/insidegui/PodcastMenu"

  livecheck do
    url "https://ghproxy.com/github.com/insidegui/PodcastMenu/raw/master/Releases/appcast.xml"
    strategy :sparkle
  end
