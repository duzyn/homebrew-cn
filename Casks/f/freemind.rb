cask "freemind" do
  ...
  url "https://downloads.sourceforge.net/freemind/freemind/#{version}/FreeMind_#{version}.dmg?use_mirror=jaist",
      verified: "downloads.sourceforge.net/freemind/?use_mirror=jaist"
  name "FreeMind"
