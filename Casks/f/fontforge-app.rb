cask "fontforge-app" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/fontforge/fontforge/releases/download/#{version.csv.first.no_hyphens}/FontForge-#{version.csv.first}-MacOS.app.dmg",
