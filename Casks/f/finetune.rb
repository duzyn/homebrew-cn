cask "finetune" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/ronitsingh10/FineTune/releases/download/v#{version}/FineTune-#{version}.dmg"
  name "FineTune"
  desc "Per-application volume mixer, equalizer, and audio router"
  homepage "https://github.com/ronitsingh10/FineTune"

  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/ronitsingh10/FineTune/main/appcast.xml"
