cask "freeplane" do
  ...
  url "https://downloads.sourceforge.net/freeplane/Freeplane-#{version}-#{arch}.dmg?use_mirror=jaist",
      verified: "downloads.sourceforge.net/freeplane/?use_mirror=jaist"
  name "Freeplane"
