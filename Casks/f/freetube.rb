cask "freetube" do
  ...
  on_catalina do
    ...
    url "https://mirror.ghproxy.com/https://github.com/FreeTubeApp/FreeTube/releases/download/v#{version}-beta/freetube-#{version}-mac-x64.dmg",
  ...
  on_big_sur :or_newer do
    ...
    url "https://mirror.ghproxy.com/https://github.com/FreeTubeApp/FreeTube/releases/download/v#{version}-beta/freetube-#{version}-beta-mac-#{arch}.dmg",
        verified: "github.com/FreeTubeApp/FreeTube/"
