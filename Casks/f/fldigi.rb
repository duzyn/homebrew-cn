cask "fldigi" do
  ...
  on_sierra :or_older do
    ...
    url "https://downloads.sourceforge.net/fldigi/fldigi/fldigi-#{version}_LI.dmg?use_mirror=jaist",
        verified: "sourceforge.net/fldigi/"
  end
  on_high_sierra :or_newer do
    sha256 "eb18e4d28ca86ad0667af80dcb8b973a7b1875fdcfc9df1b64203ce12237d322"

    url "https://downloads.sourceforge.net/fldigi/fldigi/fldigi-#{version}_VN.dmg?use_mirror=jaist",
        verified: "sourceforge.net/fldigi/"
  end
