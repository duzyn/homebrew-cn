cask "fldigi" do
  ...
  on_sierra :or_older do
    ...
    url "https://downloads.sourceforge.net/fldigi/fldigi/fldigi-#{version}_LI.dmg?use_mirror=nchc"
  end
  on_high_sierra :or_newer do
    sha256 "3f28609899c085d182d121441ffa450d7ed95aac10bb6faeb12d90f20a3f9a7a"

    url "https://downloads.sourceforge.net/fldigi/fldigi/fldigi-#{version}_VN.dmg?use_mirror=nchc"
  end
