cask "far2l" do
  ...
  on_mojave :or_older do
    ...
    url "https://mirror.ghproxy.com/https://github.com/elfmz/far2l/releases/download/v_#{version}/far2l-#{version}-beta-MacOS-10.11-x64.dmg"
  end
  on_catalina do
    sha256 "8b94145c13c7636e6cedfe0029ae3da0f0fdf1ac7ecc641ff4cb775c88ef4bf4"

    url "https://mirror.ghproxy.com/https://github.com/elfmz/far2l/releases/download/v_#{version}/far2l-#{version}-beta-MacOS-10.15-x64.dmg"
  end
  on_big_sur :or_newer do
    sha256 "6ff8547359d73260b386d20639be5e034777131519cf7acc9b0270f0fb8fe57d"

    url "https://mirror.ghproxy.com/https://github.com/elfmz/far2l/releases/download/v_#{version}/far2l-#{version}-beta-MacOS-11.2-universal.dmg"
  end
