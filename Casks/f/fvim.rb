cask "fvim" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/yatli/fvim/releases/download/v#{version.csv.first}%2B#{version.csv.second}/fvim-osx-x64-v0.3.548+g2e4087d-2-g#{version.csv.second}.zip"
  name "FVim"
