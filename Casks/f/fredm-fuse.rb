cask "fredm-fuse" do
  ...
  url "https://downloads.sourceforge.net/fuse-for-macosx/fuse-for-macosx/#{version}/FuseForMacOS-#{version}.zip?use_mirror=jaist",
      verified: "downloads.sourceforge.net/fuse-for-macosx/?use_mirror=jaist"
