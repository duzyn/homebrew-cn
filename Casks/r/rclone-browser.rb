cask "rclone-browser" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/mmozeiko/RcloneBrowser/releases/download/#{version.csv.first}/rclone-browser-#{version.csv.first}-#{version.csv.second}-macOS.zip",
