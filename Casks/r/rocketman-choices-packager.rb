cask "rocketman-choices-packager" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/Rocketman-Tech/Rocketman-Choices-Packager/releases/download/v#{version}/Rocketman-Choices-Packager-v#{version}.pkg"
