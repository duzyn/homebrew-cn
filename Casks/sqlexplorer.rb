cask "sqlexplorer" do
  ...
  url "https://downloads.sourceforge.net/eclipsesql/SQL%20Explorer%20RCP%20%28exc%20JRE%29/#{version}/sqlexplorer_rcp-#{version}.macosx.cocoa.x86.tgz?use_mirror=nchc",
      verified: "downloads.sourceforge.net/eclipsesql/?use_mirror=nchc"
