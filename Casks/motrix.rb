cask "motrix" do
  ...
  on_intel do
    ...
    url "https://ghproxy.com/github.com/agalwood/Motrix/releases/download/v#{version}/Motrix-#{version}.dmg",
        verified: "github.com/agalwood/Motrix/"
  end
  on_arm do
    sha256 "1705d6ef4781c17ebf19007dbb2ac52f6227592c783e91ad5b81a1432cf6b668"

    url "https://ghproxy.com/github.com/agalwood/Motrix/releases/download/v#{version}/Motrix-#{version}-arm64.dmg",
        verified: "github.com/agalwood/Motrix/"
  end
