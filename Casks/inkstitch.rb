cask "inkstitch" do
  ...
  on_high_sierra :or_older do
    ...
    url "https://ghproxy.com/github.com/inkstitch/inkstitch/releases/download/v#{version}/inkstitch-v#{version}-sierra-osx.pkg",
  ...
  on_mojave :or_newer do
    ...
    url "https://ghproxy.com/github.com/inkstitch/inkstitch/releases/download/v#{version}/inkstitch-v#{version}-osx.pkg",
        verified: "github.com/inkstitch/inkstitch/"
