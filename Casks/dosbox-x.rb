cask "dosbox-x" do
  ...
  url "https://ghproxy.com/github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-windows-v#{version.csv.first}/dosbox-x-macosx-#{arch}-#{version.csv.second}.zip",
