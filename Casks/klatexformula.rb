cask "klatexformula" do
  ...
  url "https://downloads.sourceforge.net/klatexformula/klatexformula/klatexformula-#{version}/klatexformula-#{version}-macosx.dmg?use_mirror=nchc",
      verified: "downloads.sourceforge.net/klatexformula/?use_mirror=nchc"
  name "KLatexFormula"
