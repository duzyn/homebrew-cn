cask "asset-catalog-tinkerer" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/insidegui/AssetCatalogTinkerer/releases/download/#{version}/AssetCatalogTinkerer_v#{version}-#{version.no_dots.ljust(3, "0")}.zip"
