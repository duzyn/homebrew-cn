cask "ansible-dk" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/omniti-labs/ansible-dk/releases/download/#{version.csv.first}/ansible-dk-#{version.csv.first}-#{version.csv.second}.dmg"
  name "Ansible DK"
