cask "archiver-app" do
  ...
  url "https://mirror.ghproxy.com/https://mirror.ghproxy.com/https://github.com/incbee/archiver-#{version.major}-releases/releases/download/v#{version}/Archiver-#{version}-universal-mac.zip",
      verified: "mirror.ghproxy.com/https://github.com/incbee/archiver-#{version.major}-releases/"
  name "Archiver"
