cask "another-redis-desktop-manager" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/qishibo/AnotherRedisDesktopManager/releases/download/v#{version}/Another-Redis-Desktop-Manager#{arch}#{version}.dmg"
