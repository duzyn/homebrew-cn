cask "appexindexer" do
  ...
  livecheck do
    # Update to match other Eclectic Light casks if AppexIndexer is added to https://mirror.ghproxy.com/https://raw.githubusercontent.com/hoakleyelc/updates/master/eclecticapps.plist
    url :homepage
