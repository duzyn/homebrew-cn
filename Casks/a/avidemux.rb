cask "avidemux" do
  on_big_sur :or_older do
    ...
    url "https://downloads.sourceforge.net/avidemux/avidemux/#{version}/Avidemux_#{version}_Mojava_64Bits_Qt5.dmg?use_mirror=jaist",
  ...
  on_monterey :or_newer do
    ...
    url "https://downloads.sourceforge.net/avidemux/avidemux/#{version}/Avidemux_#{version}v2_Monterey_Qt6.dmg?use_mirror=jaist",
        verified: "sourceforge.net/avidemux/"
  end
