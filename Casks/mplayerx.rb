cask "mplayerx" do
  ...
  url "https://ghproxy.com/github.com/niltsh/MPlayerX-Deploy/releases/download/#{version.csv.first}/MPlayerX-#{version.csv.first}-#{version.csv.second}.zip",
  ...
  livecheck do
    url "https://ghproxy.com/raw.githubusercontent.com/niltsh/MPlayerX-Deploy/master/appcast.xml"
    strategy :sparkle
  end
