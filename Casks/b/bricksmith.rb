cask "bricksmith" do
  ...
  url "https://downloads.sourceforge.net/bricksmith/bricksmith/Bricksmith%20#{version.major_minor}/BricksmithComplete#{version.major_minor}.zip?use_mirror=jaist",
      verified: "downloads.sourceforge.net/bricksmith/?use_mirror=jaist"
  name "Bricksmith"
