cask "brain-workshop" do
  ...
  url "https://downloads.sourceforge.net/brainworkshop/brainworkshop/Brain%20Workshop%20#{version.major_minor}/brainworkshop-#{version}-MacOSX.zip?use_mirror=jaist"
  name "Brain Workshop"
