cask "bitbox" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/digitalbitbox/bitbox-wallet-app/releases/download/v#{version}/BitBox-#{version}-macOS.zip",
      verified: "mirror.ghproxy.com/https://github.com/digitalbitbox/bitbox-wallet-app/releases/download/"
  name "BitBox"
