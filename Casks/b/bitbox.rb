cask "bitbox" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/BitBoxSwiss/bitbox-wallet-app/releases/download/v#{version}/BitBox-#{version}-macOS.dmg",
      verified: "mirror.ghproxy.com/https://github.com/BitBoxSwiss/bitbox-wallet-app/releases/download/"
  name "BitBox"
