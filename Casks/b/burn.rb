cask "burn" do
  ...
  url "https://downloads.sourceforge.net/burn-osx/Burn/#{version}/burn-#{version}.zip?use_mirror=jaist",
      verified: "downloads.sourceforge.net/burn-osx/?use_mirror=jaist"
  name "Burn"
