cask "brewy" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/p-linnane/Brewy/releases/download/#{version}/Brewy-#{version}.zip"
  name "Brewy"
  desc "Simple Homebrew GUI"
  homepage "https://github.com/p-linnane/Brewy"

  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/p-linnane/Brewy/appcast/appcast.xml"
