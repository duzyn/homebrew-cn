cask "batteryboi" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/thebarbican19/BatteryBoi/releases/download/Version#{version.csv.first}%23#{version.csv.second}/BatteryBoi-V#{version.csv.first}.dmg",
