cask "bambu-studio" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/bambulab/BambuStudio/releases/download/v#{version.csv.first}/Bambu_Studio_mac-v#{version.csv.first}-#{version.csv.second}.dmg",
