cask "prismlauncher" do
  ...
  if MacOS.version < :catalina
    ...
    url "https://ghproxy.com/github.com/PrismLauncher/PrismLauncher/releases/download/#{version}/PrismLauncher-macOS-Legacy-#{version}.tar.gz",
        verified: "github.com/PrismLauncher/PrismLauncher"
  else
    sha256 "9bbf29b4c3f829d0fe55bd9cb96ba463c9840cc3663c3dffb5f1cfde99a62f6a"
    url "https://ghproxy.com/github.com/PrismLauncher/PrismLauncher/releases/download/#{version}/PrismLauncher-macOS-#{version}.tar.gz",
        verified: "github.com/PrismLauncher/PrismLauncher"
  end
  name "Prism Launcher"
