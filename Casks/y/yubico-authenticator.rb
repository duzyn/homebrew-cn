cask "yubico-authenticator" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/Yubico/yubioath-flutter/releases/download/#{version}/yubico-authenticator-#{version}-mac.dmg",
      verified: "mirror.ghproxy.com/https://github.com/Yubico/yubioath-flutter/releases/download/"
