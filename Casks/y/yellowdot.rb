cask "yellowdot" do
  on_monterey :or_older do
    ...
    url "https://mirror.ghproxy.com/https://github.com/FuzzyIdeas/YellowDot/releases/download/v#{version}/YellowDot.zip",
  ...
  on_ventura :or_newer do
    ...
    url "https://mirror.ghproxy.com/https://github.com/FuzzyIdeas/YellowDot/releases/download/v#{version}/YellowDot-#{version}.dmg",
        verified: "github.com/FuzzyIdeas/YellowDot/"
  end
