cask "iris" do
  ...
  url "https://ghproxy.com/raw.githubusercontent.com/danielng01/product-builds/master/iris/macos/Iris-#{version}-OSX.zip",
      verified: "ghproxy.com/raw.githubusercontent.com/danielng01/product-builds/"
  name "Iris"
