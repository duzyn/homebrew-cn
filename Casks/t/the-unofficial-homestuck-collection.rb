cask "the-unofficial-homestuck-collection" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/Bambosh/unofficial-homestuck-collection/releases/download/v#{version}/The-Unofficial-Homestuck-Collection-#{version}.dmg",
