cask "trezor-bridge" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/trezor/webwallet-data/raw/master/bridge/#{version}/trezor-bridge-#{version}.pkg",
  ...
  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/trezor/webwallet-data/master/bridge/latest"
    regex(/(\d+(?:\.\d+)+)/i)
  end
