cask "thor" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/gbammc/Thor/releases/download/#{version}/Thor_#{version}.zip"
  name "Thor"
  desc "Utility to switch between applications"
  homepage "https://github.com/gbammc/Thor/"

  livecheck do
    url "https://mirror.ghproxy.com/https://github.com/gbammc/Thor/raw/master/Releases/appcast.xml"
