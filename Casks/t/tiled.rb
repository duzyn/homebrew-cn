cask "tiled" do
  ...
  on_catalina :or_older do
    ...
    url "https://mirror.ghproxy.com/https://github.com/mapeditor/tiled/releases/download/v#{version}/Tiled-#{version}_macOS-10.12-10.15.zip",
        verified: "github.com/mapeditor/tiled/"
  end
  on_big_sur :or_newer do
    sha256 "f84de6ab521d4121eecf7fc419a1ba4a6b86f4200b20bbfc7ae1bfd9cf883272"

    url "https://mirror.ghproxy.com/https://github.com/mapeditor/tiled/releases/download/v#{version}/Tiled-#{version}_macOS-11+.zip",
        verified: "github.com/mapeditor/tiled/"
  end
