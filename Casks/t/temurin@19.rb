cask "temurin@19" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/adoptium/temurin19-binaries/releases/download/jdk-#{version.csv.first}%2B#{version.csv.second}/OpenJDK19U-jdk_#{arch}_mac_hotspot_#{version.csv.first}_#{version.csv.second.major}.pkg",
