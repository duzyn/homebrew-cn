cask "transmission-beta" do
  ...
  url "https://ghproxy.com/github.com/transmission/transmission/releases/download/#{version.csv.first}/Transmission-#{version.csv.first}%2B#{version.csv.second}.dmg",
