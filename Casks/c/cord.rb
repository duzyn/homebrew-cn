cask "cord" do
  ...
  url "https://downloads.sourceforge.net/cord/cord/#{version.csv.first}/CoRD_#{version}.zip?use_mirror=nchc",
      verified: "downloads.sourceforge.net/cord/?use_mirror=nchc"
  name "CoRD"
