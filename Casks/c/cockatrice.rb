cask "cockatrice" do
  ...
  on_ventura :or_newer do
    ...
    on_sonoma do
      ...
      url "https://mirror.ghproxy.com/https://github.com/Cockatrice/Cockatrice/releases/download/#{version.csv.second}-Release-#{version.csv.first}/Cockatrice-#{version.csv.third}-#{version.csv.fourth}-macOS14.dmg",
          verified: "github.com/Cockatrice/Cockatrice/"
    end
    on_sequoia :or_newer do
      sha256 "5ebebf79bf50315f5f7e0dfc015a0775f9fd269fe4b26ffb4ab4f0ec7ebd1cfd"

      url "https://mirror.ghproxy.com/https://github.com/Cockatrice/Cockatrice/releases/download/#{version.csv.second}-Release-#{version.csv.first}/Cockatrice-#{version.csv.third}-#{version.csv.fourth}-macOS15.dmg",
          verified: "github.com/Cockatrice/Cockatrice/"
    end
