cask "cockatrice" do
  on_monterey :or_older do
    ...
    url "https://mirror.ghproxy.com/https://github.com/Cockatrice/Cockatrice/releases/download/#{version.csv.second}-Release-#{version.csv.first}/Cockatrice-#{version.csv.third}-#{version.csv.first}-macOS-11_Big_Sur.dmg",
  ...
  on_ventura do
    ...
    url "https://mirror.ghproxy.com/https://github.com/Cockatrice/Cockatrice/releases/download/#{version.csv.second}-Release-#{version.csv.first}/Cockatrice-#{version.csv.third}-#{version.csv.fourth}-macOS13_Intel.dmg",
        verified: "github.com/Cockatrice/Cockatrice/"
  ...
  on_sonoma do
    ...
    url "https://mirror.ghproxy.com/https://github.com/Cockatrice/Cockatrice/releases/download/#{version.csv.second}-Release-#{version.csv.first}/Cockatrice-#{version.csv.third}-#{version.csv.fourth}-macOS14_Apple.dmg",
        verified: "github.com/Cockatrice/Cockatrice/"
  end
  on_sequoia :or_newer do
    ...
    url "https://mirror.ghproxy.com/https://github.com/Cockatrice/Cockatrice/releases/download/#{version.csv.second}-Release-#{version.csv.first}/Cockatrice-#{version.csv.third}-#{version.csv.fourth}-macOS15_Apple.dmg",
        verified: "github.com/Cockatrice/Cockatrice/"
  end
