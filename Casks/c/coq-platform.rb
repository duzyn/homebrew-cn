cask "coq-platform" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/coq/platform/releases/download/#{version.csv.first}/coq-Platform-release-#{version.csv.first}-version.#{version.csv.second}-MacOS-#{arch}.dmg",
