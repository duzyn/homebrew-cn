cask "cilicon" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/traderepublic/Cilicon/releases/download/v#{version.csv.first}/Cilicon_#{version.csv.first}_#{version.csv.second}_adhoc.zip"
  name "Cilicon"
