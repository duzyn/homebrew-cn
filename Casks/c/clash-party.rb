cask "clash-party" do
  ...
  on_catalina :or_older do
    ...
    url "https://mirror.ghproxy.com/https://github.com/mihomo-party-org/clash-party/releases/download/v#{version}/clash-party-catalina-#{version}-#{arch}.pkg",
  ...
  on_big_sur :or_newer do
    ...
    url "https://mirror.ghproxy.com/https://github.com/mihomo-party-org/clash-party/releases/download/v#{version}/clash-party-macos-#{version}-#{arch}.pkg",
        verified: "github.com/mihomo-party-org/clash-party/"
