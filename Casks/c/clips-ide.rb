cask "clips-ide" do
  ...
  url "https://downloads.sourceforge.net/clipsrules/clips_macos_executable_#{version.no_dots}.dmg?use_mirror=jaist",
      verified: "downloads.sourceforge.net/clipsrules/?use_mirror=jaist"
  name "CLIPS IDE"
