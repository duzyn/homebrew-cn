cask "cemu" do
  ...
  on_catalina do
    ...
    url "https://mirror.ghproxy.com/https://github.com/CE-Programming/CEmu/releases/download/v#{version}/CEmu-v#{version}_macOS_Qt5_intel.dmg",
        verified: "github.com/CE-Programming/CEmu/"
  end
  on_big_sur :or_newer do
    ...
    url "https://mirror.ghproxy.com/https://github.com/CE-Programming/CEmu/releases/download/v#{version}/CEmu-v#{version}_macOS_Qt6_#{arch}.dmg",
        verified: "github.com/CE-Programming/CEmu/"
  end
