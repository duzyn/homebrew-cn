cask "cmd" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/getcmd-dev/cmd/releases/download/v#{version}/cmd.dmg",
  ...
  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/getcmd-dev/cmd/main/app/fastlane/appcast.xml"
