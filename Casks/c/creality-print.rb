cask "creality-print" do
  ...
  on_arm do
    ...
    url "https://mirror.ghproxy.com/https://github.com/CrealityOfficial/CrealityPrint/releases/download/v#{version.csv.first.major_minor_patch}/Creality_Print-v#{version.csv.first}#{arch}-Release.dmg",
  ...
  on_intel do
    ...
    url "https://mirror.ghproxy.com/https://github.com/CrealityOfficial/CrealityPrint/releases/download/v#{version.csv.first.major_minor_patch}/CrealityPrint_#{version.csv.first}_Release.dmg",
        verified: "github.com/CrealityOfficial/CrealityPrint/"
  end
