cask "cameracontroller" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/Itaybre/CameraController/releases/download/v#{version}/CameraController.zip"
  name "CameraController"
  desc "Control USB Cameras from an app"
  homepage "https://github.com/Itaybre/CameraController/"

  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Itaybre/CameraController/master/appcast.xml"
