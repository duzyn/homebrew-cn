cask "djv" do
  ...
  url "https://downloads.sourceforge.net/djv/djv-stable/#{version}/DJV-#{version}-Darwin.dmg?use_mirror=nchc",
      verified: "downloads.sourceforge.net/djv/?use_mirror=nchc"
  name "DJV Imaging"
