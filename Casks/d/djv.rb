cask "djv" do
  ...
  url "https://downloads.sourceforge.net/djv/djv-stable/#{version}/DJV-#{version}-Darwin.dmg?use_mirror=jaist",
      verified: "downloads.sourceforge.net/djv/?use_mirror=jaist"
  name "DJV Imaging"
