cask "dockmate" do
  ...
  url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/w0lfschild/app_updates/master/DockMate/DockMate.#{version}.zip",
      verified: "mirror.ghproxy.com/https://raw.githubusercontent.com/w0lfschild/"
  name "Dock Mate"
  desc "Window previews and controls"
  homepage "https://www.macenhance.com/dockmate"

  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/w0lfschild/app_updates/master/DockMate/appcast.xml"
