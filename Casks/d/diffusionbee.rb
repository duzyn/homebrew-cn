cask "diffusionbee" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/divamgupta/diffusionbee-stable-diffusion-ui/releases/download/#{version}/DiffusionBee_MPS_#{arch}-#{version}.dmg",
