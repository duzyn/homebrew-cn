cask "double-commander" do
  ...
  url "https://downloads.sourceforge.net/doublecmd/doublecmd-#{version.tr(",", "-")}.cocoa.#{arch}.dmg?use_mirror=jaist",
      verified: "downloads.sourceforge.net/doublecmd/?use_mirror=jaist"
