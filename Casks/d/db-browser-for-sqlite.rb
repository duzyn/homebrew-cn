cask "db-browser-for-sqlite" do
  ...
  on_catalina :or_older do
    ...
    url "https://mirror.ghproxy.com/https://github.com/sqlitebrowser/sqlitebrowser/releases/download/v#{version}/DB.Browser.for.SQLite#{arch}-#{version}.dmg",
  ...
  on_big_sur :or_newer do
    ...
    url "https://mirror.ghproxy.com/https://github.com/sqlitebrowser/sqlitebrowser/releases/download/v#{version}/DB.Browser.for.SQLite-v#{version}.dmg",
        verified: "github.com/sqlitebrowser/sqlitebrowser/"
