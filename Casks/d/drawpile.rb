cask "drawpile" do
  ...
  on_big_sur :or_older do
    ...
    url "https://mirror.ghproxy.com/https://github.com/drawpile/Drawpile/releases/download/#{version}/Drawpile-#{version}.dmg",
  ...
  on_monterey :or_newer do
    ...
    url "https://mirror.ghproxy.com/https://github.com/drawpile/Drawpile/releases/download/#{version}/Drawpile-#{version}-#{arch}.dmg",
        verified: "github.com/drawpile/Drawpile"
