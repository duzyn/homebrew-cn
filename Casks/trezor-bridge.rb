cask "trezor-bridge" do
  ...
  url "https://ghproxy.com/github.com/trezor/webwallet-data/raw/master/bridge/#{version}/trezor-bridge-#{version}.pkg",
  ...
  livecheck do
    url "https://ghproxy.com/raw.githubusercontent.com/trezor/webwallet-data/master/bridge/latest"
    regex(/(\d+(?:\.\d+)+)/i)
  end
