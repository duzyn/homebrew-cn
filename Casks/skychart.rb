cask "skychart" do
  ...
  url "https://downloads.sourceforge.net/skychart/skychart-#{version}-x86_64-macosx.dmg?use_mirror=nchc",
      verified: "downloads.sourceforge.net/skychart/?use_mirror=nchc"
  name "SkyChart"
  name "Cartes du Ciel"
