cask "visit" do
  on_big_sur :or_older do
    ...
    url "https://mirror.ghproxy.com/https://github.com/visit-dav/visit/releases/download/v#{version}/Visit-#{version}.dmg",
  ...
  on_monterey :or_newer do
    ...
    url "https://mirror.ghproxy.com/https://github.com/visit-dav/visit/releases/download/v#{version}/visit#{version.dots_to_underscores}.darwin#{arch}.dmg",
        verified: "github.com/visit-dav/visit/"
