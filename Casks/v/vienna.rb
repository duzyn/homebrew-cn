cask "vienna" do
  ...
  url "https://downloads.sourceforge.net/vienna-rss/v_#{version}/Vienna#{version}.tgz?use_mirror=jaist",
      verified: "downloads.sourceforge.net/vienna-rss/?use_mirror=jaist"
  name "Vienna"
