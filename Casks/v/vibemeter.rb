cask "vibemeter" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/steipete/VibeMeter/releases/download/v#{version}/VibeMeter-#{version}.dmg",
  ...
  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/steipete/VibeMeter/main/appcast.xml"
