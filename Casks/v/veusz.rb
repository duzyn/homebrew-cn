cask "veusz" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/veusz/veusz/releases/download/veusz-#{version.csv.second || version.csv.first}/veusz-#{version.csv.first}-AppleOSX-#{arch}.dmg",
