cask "hermes" do
  ...
  url "https://ghproxy.com/github.com/HermesApp/Hermes/releases/download/v#{version.csv.first}/Hermes-#{version.csv.first}.zip",
      verified: "github.com/HermesApp/Hermes/"
  name "Hermes"
  homepage "https://hermesapp.org/"

  livecheck do
    url "https://ghproxy.com/raw.githubusercontent.com/HermesApp/HermesApp.github.io/master/versions.xml"
    strategy :sparkle
  end
