cask "create-recovery-partition-installer" do
  ...
  url "https://ghproxy.com/github.com/MagerValp/Create-Recovery-Partition-Installer/releases/download/v#{version}/Create.Recovery.Partition.Installer-#{version}.dmg"
