cask "sol" do
  ...
  url "https://ghproxy.com/raw.githubusercontent.com/ospfranco/sol/main/releases/#{version}.zip",
      verified: "ghproxy.com/raw.githubusercontent.com/ospfranco/sol/"
  name "Sol"
  desc "Launcher & command palette"
  homepage "https://github.com/ospfranco/sol"

  livecheck do
    url "https://ghproxy.com/raw.githubusercontent.com/ospfranco/sol/main/releases/appcast.xml"
