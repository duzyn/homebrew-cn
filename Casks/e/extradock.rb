cask "extradock" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/AppitStudio/extra-dock-updates/releases/download/v#{version}/extraDock.dmg",
  ...
  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/AppitStudio/extra-dock-updates/refs/heads/main/appcast.xml"
