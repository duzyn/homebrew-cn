cask "excalidrawz" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/chocoford/ExcalidrawZ/releases/download/v#{version}/ExcalidrawZ.#{version}.dmg",
      verified: "mirror.ghproxy.com/https://github.com/chocoford/ExcalidrawZ/releases/download/"
  name "ExcalidrawZ"
