cask "maccy" do
  ...
  url "https://ghproxy.com/github.com/p0deje/Maccy/releases/download/#{version.csv.first}/Maccy.app.zip",
  ...
  livecheck do
    url "https://ghproxy.com/raw.githubusercontent.com/p0deje/Maccy/master/appcast.xml"
    strategy :sparkle
  end
