cask "prismlauncher" do
  ...
  on_mojave :or_older do
    ...
    url "https://mirror.ghproxy.com/https://github.com/PrismLauncher/PrismLauncher/releases/download/#{version}/PrismLauncher-macOS-Legacy-#{version}.tar.gz",
  ...
  on_catalina :or_newer do
    ...
    url "https://mirror.ghproxy.com/https://github.com/PrismLauncher/PrismLauncher/releases/download/#{version}/PrismLauncher-macOS-#{version}.tar.gz",
        verified: "github.com/PrismLauncher/PrismLauncher/"
  end
