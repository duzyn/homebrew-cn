cask "playcover-community" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/PlayCover/PlayCover/releases/download/#{version}/PlayCover_#{version}.dmg"
  name "PlayCover"
  desc "Sideload iOS apps and games"
  homepage "https://github.com/PlayCover/PlayCover"

  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/PlayCover/PlayCover/update/appcast.xml"
