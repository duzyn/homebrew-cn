cask "postgres-unofficial" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/PostgresApp/PostgresApp/releases/download/v#{version.csv.first}/Postgres-#{version.csv.first}-#{version.csv.second}.dmg",
