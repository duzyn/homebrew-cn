cask "posterazor" do
  ...
  url "https://downloads.sourceforge.net/posterazor/Binary%20Releases/#{version}/PosteRazor-#{version}-OSX.dmg?use_mirror=nchc",
      verified: "downloads.sourceforge.net/posterazor/?use_mirror=nchc"
  name "PosteRazor"
