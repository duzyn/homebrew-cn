cask "processing@3" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/processing/processing/releases/download/processing-#{version.csv.second}-#{version.csv.first}/processing-#{version.csv.first}-macosx.zip",
