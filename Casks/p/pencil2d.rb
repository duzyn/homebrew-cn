cask "pencil2d" do
  on_arm do
    ...
    url "https://mirror.ghproxy.com/https://github.com/pencil2d/pencil/releases/download/v#{version}/pencil2d-mac-v#{version}.dmg",
  ...
  on_intel do
    ...
    url "https://mirror.ghproxy.com/https://github.com/pencil2d/pencil/releases/download/v#{version}/pencil2d-mac-#{version}.zip",
        verified: "github.com/pencil2d/pencil/"
