cask "anki" do
  ...
  url "https://ghproxy.com/github.com/ankitects/anki/releases/download/#{version}/anki-#{version}-mac-#{arch}-qt6.dmg",
      verified: "github.com/ankitects/anki/"

  on_high_sierra :or_older do
    sha256 "e2a2f0e2121acf6c98054d4365ac13290df6ce3486b1be13f4f93312202c57c0"

    url "https://ghproxy.com/github.com/ankitects/anki/releases/download/#{version}/anki-#{version}-mac-#{arch}-qt5.dmg",
        verified: "github.com/ankitects/anki/"
  end
