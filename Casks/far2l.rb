cask "far2l" do
  ...
  if MacOS.version <= :mojave
    url "https://ghproxy.com/github.com/elfmz/far2l/releases/download/v_#{version}/far2l-#{version}-beta-MacOS-10.11.dmg"
    sha256 "f2c1740d1ce950aa7643c44184339ec13056d5a41169c536cb58616014229d3e"
  else
    url "https://ghproxy.com/github.com/elfmz/far2l/releases/download/v_#{version}/far2l-#{version}-beta-MacOS-10.15.dmg"
