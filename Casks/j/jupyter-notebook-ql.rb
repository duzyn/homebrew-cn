cask "jupyter-notebook-ql" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/jendas1/jupyter-notebook-quick-look/releases/download/v#{version}/jupyter-notebook-quick-look.qlgenerator.zip"
