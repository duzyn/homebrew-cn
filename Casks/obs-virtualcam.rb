cask "obs-virtualcam" do
  ...
  url "https://ghproxy.com/github.com/johnboiles/obs-mac-virtualcam/releases/download/v#{version.csv.first}/obs-mac-virtualcam-#{version.csv.second}-v#{version.csv.first}.pkg"
