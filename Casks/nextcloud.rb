cask "nextcloud" do
  on_el_capitan :or_older do
    ...
    url "https://ghproxy.com/github.com/nextcloud/desktop/releases/download/v#{version.major_minor_patch}/Nextcloud-#{version}.pkg",
  ...
  on_sierra :or_newer do
    ...
    url "https://ghproxy.com/github.com/nextcloud/desktop/releases/download/v#{version}/Nextcloud-#{version}.pkg",
        verified: "github.com/nextcloud/desktop/"
  end
