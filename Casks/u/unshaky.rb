cask "unshaky" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/aahung/Unshaky/releases/download/v#{version}/Unshaky_v#{version}.zip"
  name "Unshaky"
  desc "Software fix for double key presses on Apple's butterfly keyboard"
  homepage "https://github.com/aahung/Unshaky"

  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/aahung/Unshaky/master/appcast.xml"
