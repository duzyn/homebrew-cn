cask "biscuit" do
  ...
  on_intel do
    ...
    url "https://ghproxy.com/github.com/agata/dl.biscuit/releases/download/v#{version}/Biscuit-#{version}.dmg",
        verified: "github.com/agata/dl.biscuit/"
  end
  on_arm do
    sha256 "b2bd9101f9eec59430db3586387cf5bcd077b06115f244ecdff9de1f4f329ac4"

    url "https://ghproxy.com/github.com/agata/dl.biscuit/releases/download/v#{version}/Biscuit-#{version}-arm64.dmg",
        verified: "github.com/agata/dl.biscuit/"
  end
