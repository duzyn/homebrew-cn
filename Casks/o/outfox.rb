cask "outfox" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/TeamRizu/OutFox/releases/download/#{version.csv.second}/#{version.csv.third}-#{version.csv.first}-#{version.csv.fourth}.dmg",
