cask "oclint" do
  ...
  on_sonoma :or_older do
    ...
    url "https://mirror.ghproxy.com/https://github.com/oclint/oclint/releases/download/v#{version}/oclint-#{version}-llvm-13.0.1-#{arch}-darwin-macos-12.2-xcode-13.2.tar.gz"
  ...
  on_sequoia :or_newer do
    ...
    url "https://mirror.ghproxy.com/https://github.com/oclint/oclint/releases/download/v#{version}/oclint-#{version}-llvm-16.0.5-#{arch}-darwin-macos-15.1.1-xcode-16.1.tar.gz"
