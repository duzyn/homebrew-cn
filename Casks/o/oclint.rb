cask "oclint" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/oclint/oclint/releases/download/v#{version}/oclint-#{version}-llvm-13.0.1-x86_64-darwin-macos-12.2-xcode-13.2.tar.gz",
