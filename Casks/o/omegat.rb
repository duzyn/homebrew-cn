cask "omegat" do
  ...
  url "https://downloads.sourceforge.net/omegat/OmegaT%20-%20Standard/OmegaT%20#{version.major_minor_patch}/OmegaT_#{version}_Mac.zip?use_mirror=jaist",
      verified: "downloads.sourceforge.net/omegat/?use_mirror=jaist"
  name "OmegaT"
