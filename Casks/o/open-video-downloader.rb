cask "open-video-downloader" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/StefanLobbenmeier/youtube-dl-gui/releases/download/v#{version}/Open-Video-Downloader-#{version}-universal.dmg"
