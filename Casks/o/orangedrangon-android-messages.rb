cask "orangedrangon-android-messages" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/OrangeDrangon/android-messages-desktop/releases/download/v#{version}/Android-Messages-v#{version}-mac-universal.zip"
