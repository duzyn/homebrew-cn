cask "luanti" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/luanti-org/luanti/releases/download/#{version.csv.first}/luanti_#{version.csv.first}-macos#{version.csv.second}_#{arch}.zip",
