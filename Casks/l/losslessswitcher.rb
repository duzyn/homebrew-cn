cask "losslessswitcher" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/vincentneo/LosslessSwitcher/releases/download/#{version.csv.first}/LosslessSwitcher-#{version.csv.second || version.csv.first}.app.zip"
