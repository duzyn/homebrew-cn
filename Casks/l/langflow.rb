cask "langflow" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/langflow-ai/langflow/releases/download/#{version.csv.second || version}/Langflow_#{version.csv.first}_aarch64.dmg",
