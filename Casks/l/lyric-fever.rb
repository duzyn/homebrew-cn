cask "lyric-fever" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/aviwad/LyricFever/releases/download/v#{version.csv.second || version.csv.first}/Lyric.Fever.#{version.csv.first}.dmg",
      verified: "mirror.ghproxy.com/https://github.com/aviwad/LyricFever/releases/download/"
  name "Lyric Fever"
