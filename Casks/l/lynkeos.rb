cask "lynkeos" do
  ...
  url "https://downloads.sourceforge.net/lynkeos/lynkeos/#{version}/Lynkeos-App-#{version.dots_to_hyphens}.zip?use_mirror=jaist",
      verified: "downloads.sourceforge.net/lynkeos/?use_mirror=jaist"
  name "Lynkeos"
