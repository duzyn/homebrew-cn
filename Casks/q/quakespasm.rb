cask "quakespasm" do
  ...
  url "https://downloads.sourceforge.net/quakespasm/Mac/QuakeSpasm-#{version}-osx-SDL2.zip?use_mirror=nchc",
      verified: "downloads.sourceforge.net/quakespasm/?use_mirror=nchc"
  name "QuakeSpasm"
