cask "hex-fiend" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/ridiculousfish/HexFiend/releases/download/v#{version}/Hex_Fiend_#{version.major_minor_patch.chomp(".0")}.dmg",
  ...
  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/ridiculousfish/HexFiend/master/app/appcast.xml"
