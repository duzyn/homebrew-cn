cask "hermes" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/HermesApp/Hermes/releases/download/v#{version}/Hermes-#{version}.zip",
  ...
  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/HermesApp/HermesApp.github.io/master/versions.xml"
