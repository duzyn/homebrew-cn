cask "xcodepilot" do
  ...
  url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/TMTBO/XcodePilotPages/refs/heads/main/docs/packages/appcast/XcodePilot.v#{version.csv.first}_#{version.csv.second}.zip",
      verified: "mirror.ghproxy.com/https://raw.githubusercontent.com/TMTBO/XcodePilotPages/"
  name "XcodePilot"
  desc "Toolset for Apple developers to increase productivity and efficiency"
  homepage "https://xcodepilot.thriller.fun/docs/"

  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/TMTBO/XcodePilotPages/refs/heads/main/docs/packages/appcast/appcast.xml"
    strategy :sparkle
  end
