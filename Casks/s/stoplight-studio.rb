cask "stoplight-studio" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/stoplightio/studio/releases/download/v#{version.csv.first}-stable.#{version.csv.second}/stoplight-studio-mac-#{arch}.dmg",
