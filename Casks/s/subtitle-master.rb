cask "subtitle-master" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/subtitle-master/subtitlemaster/releases/download/v#{version}-SNAPSHOT/Subtitle.Master-osx-v#{version}-SNAPSHOT.zip"
