cask "shotcut" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/mltframework/shotcut/releases/download/v#{version.csv.first}/shotcut-macos-#{version.csv.second || version.csv.first.no_dots}.dmg",
