cask "sigil" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/Sigil-Ebook/Sigil/releases/download/#{version}/Sigil.app-#{version}-Mac#{arch}.txz",
  ...
  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Sigil-Ebook/Sigil/master/version.xml"
    strategy :xml do |xml|
