cask "status" do
  ...
  on_arm do
    ...
    url "https://mirror.ghproxy.com/https://github.com/status-im/status-desktop/releases/download/#{version.csv.first}/StatusIm-Desktop-#{version.csv.first}-#{version.csv.second}-#{arch}.dmg",
        verified: "mirror.ghproxy.com/https://github.com/status-im/status-desktop/releases/download/"
  end
  on_intel do
    version "2.32.1,aab802"
    sha256 "0335a0b16caf61354d2413d72a51100fca395f1c0c787db3b2890c7674a5a02f"

    url "https://mirror.ghproxy.com/https://github.com/status-im/status-desktop/releases/download/#{version.csv.first}/StatusIm-Desktop-v#{version.csv.first}-#{version.csv.second}-#{arch}.dmg",
        verified: "mirror.ghproxy.com/https://github.com/status-im/status-desktop/releases/download/"
  end
