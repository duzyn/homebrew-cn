cask "semeru-jdk-open@8" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/ibmruntimes/semeru8-binaries/releases/download/jdk#{version.csv.second}-#{version.csv.third}_#{version.csv.fourth}/ibm-semeru-open-jdk_x64_mac_#{version.csv.first}.pkg",
