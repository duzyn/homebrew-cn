cask "sonic-visualiser" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/sonic-visualiser/sonic-visualiser/releases/download/sv_v#{version.csv.first.major_minor}/Sonic.Visualiser.#{version.csv.first}.dmg",
