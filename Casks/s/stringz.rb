cask "stringz" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/mohakapt/Stringz/releases/download/v#{version}/Stringz-#{version}.dmg"
  name "Stringz"
  desc "Editor for localizable files"
  homepage "https://github.com/mohakapt/Stringz"

  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/mohakapt/Stringz/master/appcast.xml"
