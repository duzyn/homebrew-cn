cask "spaceradar" do
  ...
  on_arm do
    ...
    url "https://mirror.ghproxy.com/https://github.com/zz85/space-radar/releases/download/v#{version}/stable-macos-#{arch}-SpaceRadar.dmg"
  ...
  on_intel do
    ...
    url "https://mirror.ghproxy.com/https://github.com/zz85/space-radar/releases/download/v#{version}/SpaceRadar-#{version}-mac-#{arch}.zip"
