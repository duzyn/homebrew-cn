cask "stella" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/stella-emu/stella/releases/download/#{version.csv.second || version.csv.first}/Stella-#{version.csv.first}-macos.dmg",
