cask "swiftdialog" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/swiftDialog/swiftDialog/releases/download/v#{version.csv.first}/dialog-#{version.csv.first}-#{version.csv.second}.pkg",
