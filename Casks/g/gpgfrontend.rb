cask "gpgfrontend" do
  on_monterey :or_older do
    ...
    url "https://mirror.ghproxy.com/https://github.com/saturneric/GpgFrontend/releases/download/v#{version}/GpgFrontend-#{version}-macos-12.dmg",
  ...
  on_ventura do
    ...
    url "https://mirror.ghproxy.com/https://github.com/saturneric/GpgFrontend/releases/download/v#{version}/GpgFrontend-#{version}-macos-13.dmg",
        verified: "github.com/saturneric/GpgFrontend/"
  ...
  on_sonoma do
    ...
    url "https://mirror.ghproxy.com/https://github.com/saturneric/GpgFrontend/releases/download/v#{version}/GpgFrontend-#{version}-macos-14.dmg",
        verified: "github.com/saturneric/GpgFrontend/"
  end
  on_sequoia :or_newer do
    ...
    url "https://mirror.ghproxy.com/https://github.com/saturneric/GpgFrontend/releases/download/v#{version}/GpgFrontend-#{version}-macos-15.dmg",
        verified: "github.com/saturneric/GpgFrontend/"
  end
