cask "gitup-app" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/git-up/GitUp/releases/download/v#{version}/GitUp.zip",
  ...
  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/git-up/GitUp/master/appcasts/stable/appcast.xml"
