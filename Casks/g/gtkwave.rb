cask "gtkwave" do
  ...
  url "https://downloads.sourceforge.net/gtkwave/gtkwave-#{version}-osx-app/gtkwave.zip?use_mirror=nchc",
      verified: "downloads.sourceforge.net/gtkwave/?use_mirror=nchc"
  name "GTKWave"
