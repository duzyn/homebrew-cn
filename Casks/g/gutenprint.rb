cask "gutenprint" do
  ...
  url "https://downloads.sourceforge.net/gimp-print/gutenprint-#{version.major_minor}/#{version}/gutenprint-#{version}.dmg?use_mirror=nchc",
      verified: "downloads.sourceforge.net/gimp-print/?use_mirror=nchc"
  name "Gutenprint"
