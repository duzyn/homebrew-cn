cask "gutenprint" do
  ...
  url "https://downloads.sourceforge.net/gimp-print/gutenprint-#{version.major_minor}/#{version}/gutenprint-#{version}.dmg?use_mirror=jaist",
      verified: "downloads.sourceforge.net/gimp-print/?use_mirror=jaist"
  name "Gutenprint"
