cask "google-assistant" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/Melvin-Abraham/Google-Assistant-Unofficial-Desktop-Client/releases/download/v#{version}/Google-Assistant-#{version}.dmg"
