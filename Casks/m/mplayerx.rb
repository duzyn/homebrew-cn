cask "mplayerx" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/niltsh/MPlayerX-Deploy/releases/download/#{version.csv.first}/MPlayerX-#{version.csv.first}-#{version.csv.second}.zip",
  ...
  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/niltsh/MPlayerX-Deploy/master/appcast.xml"
    strategy :sparkle
  end
