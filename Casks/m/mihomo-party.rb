cask "mihomo-party" do
  ...
  on_catalina :or_older do
    ...
    url "https://mirror.ghproxy.com/https://github.com/mihomo-party-org/mihomo-party/releases/download/v#{version}/mihomo-party-catalina-#{version}-#{arch}.pkg",
        verified: "mirror.ghproxy.com/https://github.com/mihomo-party-org/mihomo-party/releases/download/"
  ...
  on_big_sur :or_newer do
    ...
    url "https://mirror.ghproxy.com/https://github.com/mihomo-party-org/mihomo-party/releases/download/v#{version}/mihomo-party-macos-#{version}-#{arch}.pkg",
        verified: "mirror.ghproxy.com/https://github.com/mihomo-party-org/mihomo-party/releases/download/"
