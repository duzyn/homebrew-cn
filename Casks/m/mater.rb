cask "mater" do
  on_arm do
    ...
    url "https://mirror.ghproxy.com/https://github.com/jasonlong/mater/releases/download/v#{version}/Mater-#{version}-arm64.dmg"
  ...
  on_intel do
    ...
    url "https://mirror.ghproxy.com/https://github.com/jasonlong/mater/releases/download/#{version}/Mater-darwin-x64.zip"
