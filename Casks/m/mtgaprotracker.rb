cask "mtgaprotracker" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/Razviar/mtgap/releases/download/v#{version}/mtgaprotracker.dmg",
  ...
  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Razviar/mtgap/master/README.md"
