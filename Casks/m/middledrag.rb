cask "middledrag" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/NullPointerDepressiveDisorder/MiddleDrag/releases/download/v#{version}/MiddleDrag-#{version}.pkg",
  ...
  livecheck do
    url "https://mirror.ghproxy.com/https://raw.githubusercontent.com/NullPointerDepressiveDisorder/MiddleDrag/appcast/appcast.xml"
    strategy :sparkle
  end
