cask "media-converter" do
  ...
  url "https://downloads.sourceforge.net/media-converter/media-converter/#{version}/media-converter-#{version}.zip?use_mirror=nchc",
      verified: "downloads.sourceforge.net/media-converter/?use_mirror=nchc"
