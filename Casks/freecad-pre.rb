cask "freecad-pre" do
  ...
  url "https://ghproxy.com/github.com/FreeCAD/FreeCAD/releases/download/#{version.csv.first}/FreeCAD_#{version.major_minor}-#{version.csv.second}-macOS-x86_64-conda.dmg",
