cask "cockatrice" do
  ...
  if MacOS.version <= :mojave
    ...
    url "https://ghproxy.com/github.com/Cockatrice/Cockatrice/releases/download/#{version.csv.second}-Release-#{version.csv.first}/Cockatrice-#{version.csv.third}-#{version.csv.first}-macOS-10.14_Mojave.dmg",
        verified: "github.com/Cockatrice/Cockatrice/"
  elsif MacOS.version <= :catalina
    sha256 "b4953e77a01c639563d6e05acb40c9ca266616e15d941dea592d10904082470f"

    url "https://ghproxy.com/github.com/Cockatrice/Cockatrice/releases/download/#{version.csv.second}-Release-#{version.csv.first}/Cockatrice-#{version.csv.third}-#{version.csv.first}-macOS-10.15_Catalina.dmg",
        verified: "github.com/Cockatrice/Cockatrice/"
  else
    sha256 "a200400b24d24c8e3e32f849e23d6714548a203d68a4456cee219901507bcd49"

    url "https://ghproxy.com/github.com/Cockatrice/Cockatrice/releases/download/#{version.csv.second}-Release-#{version.csv.first}/Cockatrice-#{version.csv.third}-#{version.csv.first}-macOS-11.0_Big_Sur.dmg",
        verified: "github.com/Cockatrice/Cockatrice/"
  end
