cask "netdownloadhelpercoapp" do
  ...
  on_mojave :or_older do
    ...
    url "https://mirror.ghproxy.com/https://github.com/aclap-dev/vdhcoapp/releases/download/v#{version}/vdhcoapp-mac13-#{arch}-installer.pkg",
  ...
  on_catalina :or_newer do
    ...
    url "https://mirror.ghproxy.com/https://github.com/aclap-dev/vdhcoapp/releases/download/v#{version}/vdhcoapp-mac-#{arch}-installer.pkg",
        verified: "github.com/aclap-dev/vdhcoapp/"
