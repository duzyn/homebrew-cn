cask "nextcloud-talk" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/nextcloud-releases/talk-desktop/releases/download/v#{version}/Nextcloud.Talk-macos-universal.dmg",
      verified: "mirror.ghproxy.com/https://github.com/nextcloud-releases/talk-desktop/releases/download/"
