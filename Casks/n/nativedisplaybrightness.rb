cask "nativedisplaybrightness" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/Bensge/NativeDisplayBrightness/releases/download/v#{version}/NativeDisplayBrightness_#{version.dots_to_underscores}.app.zip"
