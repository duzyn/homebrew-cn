cask "psi-plus" do
  ...
  url "https://downloads.sourceforge.net/psiplus/Psi+-#{version}-macOS10.15-x86_64.dmg?use_mirror=nchc",
      verified: "downloads.sourceforge.net/psiplus/?use_mirror=nchc"
  name "Psi+"
