cask "luminance-hdr" do
  ...
  url "https://downloads.sourceforge.net/qtpfsgui/luminance/LuminanceHDR_#{version}-Qt5.13.dmg?use_mirror=nchc",
      verified: "downloads.sourceforge.net/qtpfsgui/?use_mirror=nchc"
  name "Luminance HDR"
