cask "inkstitch" do
  ...
  on_big_sur :or_older do
    ...
    url "https://mirror.ghproxy.com/https://github.com/inkstitch/inkstitch/releases/download/v#{version}/inkstitch-v#{version}-high-sierra-catalina-osx-x86_64.pkg",
  ...
  on_monterey :or_newer do
    ...
    url "https://mirror.ghproxy.com/https://github.com/inkstitch/inkstitch/releases/download/v#{version}/inkstitch-v#{version}-osx-#{arch}.pkg",
        verified: "github.com/inkstitch/inkstitch/"
