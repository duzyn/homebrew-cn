cask "iconchanger" do
  ...
  url "https://mirror.ghproxy.com/https://github.com/underthestars-zhy/IconChanger/releases/download/v#{version.csv.first}/IconChanger.#{version.csv.second}.#{version.csv.third}.zip"
  name "IconChanger"
