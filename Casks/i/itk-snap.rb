cask "itk-snap" do
  ...
  url "https://downloads.sourceforge.net/itk-snap/itksnap-#{version.csv.first}-#{version.csv.second}-Darwin-#{arch}.dmg?use_mirror=jaist",
      verified: "downloads.sourceforge.net/itk-snap/?use_mirror=jaist"
  name "ITK-SNAP"
