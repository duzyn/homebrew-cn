...
: "${TEST:="false"}"
if [[ "$TEST" == "true" ]]; then
    git clone --depth 1 https://ghproxy.com/https://github.com/Homebrew/homebrew-core
    git clone --depth 1 https://ghproxy.com/https://github.com/Homebrew/homebrew-cask
    git clone --depth 1 https://ghproxy.com/https://github.com/Homebrew/homebrew-cask-versions
fi
...
for file in ./Formula/**/*.rb ./Casks/**/*.rb; do
    perl -pi -e 's#(github\.com/.+/releases/download)#ghproxy.com/https://\1#g;
                 ...
                 s#(github\.com/.+/archive)#ghproxy.com/https://\1#g;
                 ...
                 s#dbeaver\.io/files#ghproxy.com/https://github.com/dbeaver/dbeaver/releases/download#g;
                 ...
                 s#download\.calibre-ebook\.com/#ghproxy.com/https://github.com/kovidgoyal/calibre/releases/download/v#g' "$file"
done
